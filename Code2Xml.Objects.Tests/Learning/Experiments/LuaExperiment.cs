            ...
            get {
                ...
                var learningSets = new[] {
                    Tuple.Create(
                            ...
                            @"7ce84488504cd364aa5d86acceff8fb8203b9b4f"),
                    Tuple.Create(
                            @"https://github.com/copycat-killer/awesome-copycats.git",
                            @"2b565ee240c883bbb4115106eef66f9f1508a864"),
                    Tuple.Create(
                    ...
                    Tuple.Create(
                            ...
                            @"4dfffef2bc8fd5053e714533b7e6e701722c7a89"),
                    Tuple.Create(
                            @"https://github.com/haste/oUF.git",
                            @"955f9424bf53b149fb03822bb2082f8888241c78"),
                    Tuple.Create(
                    ...
                    Tuple.Create(
                            ...
                            @"599b27ee7496cef488a057aad86e1ce472190a78"),
                    Tuple.Create(
                            @"https://github.com/makotok/Hanappe.git",
                            @"b1a759fe9606bfc49a8df458629099be87ab86f5"),
                    Tuple.Create(
                    ...
                    Tuple.Create(
                            ...
                            @"74405929dca29b2c61fcb9e94c6b6d8799bb148a"),
                    Tuple.Create(
                    ...
                    Tuple.Create(
                            ...
                            @"3e1e6962658cbb78a5cd3e10c8f6abd35d59232a"),
                    Tuple.Create(
                            @"https://github.com/davidm/lua2c.git",
                            @"c5b239dd5a9fad5718ffaa16e6a30cca8053ba92"),
                    Tuple.Create(
                            @"https://github.com/haberman/jitdemo.git",
                            @"387503c5b8db268a6236a46e491d6f756ed17d31"),
                    Tuple.Create(
                            @"https://github.com/torhve/LuaWeb.git",
                            @"da1b73e7b70c938e35051a242c6fa70236e60aac"),
                    Tuple.Create(
                            @"https://github.com/henkboom/pax-britannica.git",
                            @"a7a3c0c21e5b27e6f4be3b0b817ebd29cd23fa7d"),
                    Tuple.Create(
                            @"https://github.com/roaminggamer/SSKCorona.git",
                            @"a9d6dfec85c01c2d9f8d455a10dcfefcafe35694"),
                    Tuple.Create(
                            @"https://github.com/vincentbernat/awesome-configuration.git",
                            @"b649c57c91ba4cb624f37d3f2a4249d9806da68c"),
                    Tuple.Create(
                            @"https://github.com/kikito/love-tile-tutorial.git",
                            @"92c5ce5e7e5aa9de461f948c17ed5c8d3af1d0d4"),
                    Tuple.Create(
                            @"https://github.com/dualface/quick-x-server.git",
                            @"2c037690610d92692744bf78fc136dec8068fddf"),
                    Tuple.Create(
                            @"https://github.com/geoffleyland/luatrace.git",
                            @"6150cfd6290986adab8ea948e756ee17c80d098a"),
                    Tuple.Create(
                            @"https://github.com/Yonaba/30log.git",
                            @"25022b30e58f1590ca3d2bc2c17107b869c38d62"),
                    Tuple.Create(
