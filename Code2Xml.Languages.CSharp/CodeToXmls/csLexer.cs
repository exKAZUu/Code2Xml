...
// $ANTLR 3.4 cs.g 2012-03-28 18:56:28
...
public partial class csLexer : Antlr.Runtime.Lexer
{
	...
	private void mT__117()
	{
		...
		try
		{
			int _type = T__117;
			int _channel = DefaultTokenChannel;
			// cs.g:76:8: ( 'descending' )
			DebugEnterAlt(1);
			// cs.g:76:10: 'descending'
			{
			DebugLocation(76, 10);
			Match("descending"); 
	...
	private void mT__149()
	{
		...
		try
		{
			int _type = T__149;
			int _channel = DefaultTokenChannel;
			// cs.g:108:8: ( 'namespace' )
			DebugEnterAlt(1);
			// cs.g:108:10: 'namespace'
			{
	...
	private void mT__163()
	{
		...
		try
		{
			int _type = T__163;
			int _channel = DefaultTokenChannel;
			// cs.g:122:8: ( 'protected' )
			DebugEnterAlt(1);
			// cs.g:122:10: 'protected'
			{
	...
	private void mT__175()
	{
		...
		try
		{
			int _type = T__175;
			int _channel = DefaultTokenChannel;
			// cs.g:134:8: ( 'stackalloc' )
			DebugEnterAlt(1);
			// cs.g:134:10: 'stackalloc'
			{
	...
	private void mT__187()
	{
		...
		try
		{
			int _type = T__187;
			int _channel = DefaultTokenChannel;
			// cs.g:146:8: ( 'unchecked' )
			DebugEnterAlt(1);
			// cs.g:146:10: 'unchecked'
			{
	...
	private void mGooBall()
	{
		...
		try
		{
			...
			int dilStart1556 = CharIndex;
			int dilStartLine1556 = Line;
			int dilStartCharPos1556 = CharPositionInLine;
			mDecimal_integer_literal(); 
			dil = new CommonToken(input, TokenTypes.Invalid, TokenChannels.Default, dilStart1556, CharIndex-1);
			dil.Line = dilStartLine1556;
			dil.CharPositionInLine = dilStartCharPos1556;
			...
			int sStart1566 = CharIndex;
			int sStartLine1566 = Line;
			int sStartCharPos1566 = CharPositionInLine;
			mGooBallIdentifier(); 
			s = new CommonToken(input, TokenTypes.Invalid, TokenChannels.Default, sStart1566, CharIndex-1);
			s.Line = sStartLine1566;
			s.CharPositionInLine = sStartCharPos1566;
	...
	private void mPP_CONDITIONAL()
	{
		...
		try
		{
			// cs.g:1144:15: ( ( IF_TOKEN | DEFINE_TOKEN | ELSE_TOKEN | ENDIF_TOKEN | UNDEF_TOKEN ) ( TS )* ( ( LINE_COMMENT )? | ( '\\r' | '\\n' )+ ) )
			DebugEnterAlt(1);
			// cs.g:1145:2: ( IF_TOKEN | DEFINE_TOKEN | ELSE_TOKEN | ENDIF_TOKEN | UNDEF_TOKEN ) ( TS )* ( ( LINE_COMMENT )? | ( '\\r' | '\\n' )+ )
			{
			DebugLocation(1145, 2);
			// cs.g:1145:2: ( IF_TOKEN | DEFINE_TOKEN | ELSE_TOKEN | ENDIF_TOKEN | UNDEF_TOKEN )
			int alt23=5;
			...
			case 1:
				DebugEnterAlt(1);
				// cs.g:1145:3: IF_TOKEN
				{
				DebugLocation(1145, 3);
				mIF_TOKEN(); 
			...
			case 1:
				DebugEnterAlt(1);
				// cs.g:1149:26: ( LINE_COMMENT )?
				{
				DebugLocation(1149, 26);
				// cs.g:1149:26: ( LINE_COMMENT )?
				int alt25=2;
	...
	private void mIF_TOKEN()
	{
		...
		try
		{
			CommonToken ppe = default(CommonToken);
			 ...
			 bool process = true; 
			// cs.g:1152:32: ( ( '#' ( TS )* 'if' ( TS )+ ppe= PP_EXPRESSION ) )
			DebugEnterAlt(1);
			// cs.g:1153:2: ( '#' ( TS )* 'if' ( TS )+ ppe= PP_EXPRESSION )
			{
			DebugLocation(1153, 2);
			// cs.g:1153:2: ( '#' ( TS )* 'if' ( TS )+ ppe= PP_EXPRESSION )
			DebugEnterAlt(1);
			// cs.g:1153:3: '#' ( TS )* 'if' ( TS )+ ppe= PP_EXPRESSION
			{
			...
			DebugLocation(1153, 31);
			int ppeStart2009 = CharIndex;
			int ppeStartLine2009 = Line;
			int ppeStartCharPos2009 = CharPositionInLine;
			mPP_EXPRESSION(); 
			ppe = new CommonToken(input, TokenTypes.Invalid, TokenChannels.Default, ppeStart2009, CharIndex-1);
			ppe.Line = ppeStartLine2009;
			ppe.CharPositionInLine = ppeStartCharPos2009;
	...
	private void mDEFINE_TOKEN()
	{
		...
		try
		{
			...
			// cs.g:1163:13: ( '#' ( TS )* 'define' ( TS )+ define= IDENTIFIER )
			DebugEnterAlt(1);
			// cs.g:1164:2: '#' ( TS )* 'define' ( TS )+ define= IDENTIFIER
			{
			...
			DebugLocation(1164, 38);
			int defineStart2044 = CharIndex;
			int defineStartLine2044 = Line;
			int defineStartCharPos2044 = CharPositionInLine;
			mIDENTIFIER(); 
			define = new CommonToken(input, TokenTypes.Invalid, TokenChannels.Default, defineStart2044, CharIndex-1);
			define.Line = defineStartLine2044;
			define.CharPositionInLine = defineStartCharPos2044;
	...
	private void mUNDEF_TOKEN()
	{
		...
		try
		{
			...
			// cs.g:1169:12: ( '#' ( TS )* 'undef' ( TS )+ define= IDENTIFIER )
			DebugEnterAlt(1);
			// cs.g:1170:2: '#' ( TS )* 'undef' ( TS )+ define= IDENTIFIER
			{
			...
			DebugLocation(1170, 37);
			int defineStart2079 = CharIndex;
			int defineStartLine2079 = Line;
			int defineStartCharPos2079 = CharPositionInLine;
			mIDENTIFIER(); 
			define = new CommonToken(input, TokenTypes.Invalid, TokenChannels.Default, defineStart2079, CharIndex-1);
			define.Line = defineStartLine2079;
			define.CharPositionInLine = defineStartCharPos2079;
	...
	private void mELSE_TOKEN()
	{
		...
		try
		{
			...
			// cs.g:1176:11: ( ( '#' ( TS )* e= 'else' | '#' ( TS )* 'elif' ( TS )+ PP_EXPRESSION ) )
			DebugEnterAlt(1);
			// cs.g:1177:2: ( '#' ( TS )* e= 'else' | '#' ( TS )* 'elif' ( TS )+ PP_EXPRESSION )
			{
			...
			case 1:
				...
				DebugLocation(1177, 18);
				int eStart = CharIndex;
				Match("else"); 
				int eStartLine2107 = Line;
				int eStartCharPos2107 = CharPositionInLine;
				e = new CommonToken(input, TokenTypes.Invalid, TokenChannels.Default, eStart, CharIndex-1);
				e.Line = eStartLine2107;
				e.CharPositionInLine = eStartCharPos2107;

				}
				break;
			case 2:
				DebugEnterAlt(2);
				// cs.g:1178:4: '#' ( TS )* 'elif' ( TS )+ PP_EXPRESSION
				{
	...
	private void mENDIF_TOKEN()
	{
		...
		try
		{
			// cs.g:1218:12: ( '#' ( TS )* 'endif' )
			DebugEnterAlt(1);
			// cs.g:1219:2: '#' ( TS )* 'endif'
			{
			DebugLocation(1219, 2);
			Match('#'); 
			DebugLocation(1219, 8);
			// cs.g:1219:8: ( TS )*
	...
	private void mPP_EXPRESSION()
	{
		...
		try
		{
			// cs.g:1230:14: ( PP_OR_EXPRESSION )
			DebugEnterAlt(1);
			// cs.g:1231:2: PP_OR_EXPRESSION
			{
	...
	private void mPP_OR_EXPRESSION()
	{
		...
		try
		{
			// cs.g:1233:17: ( PP_AND_EXPRESSION ( TS )* ( '||' ( TS )* PP_AND_EXPRESSION ( TS )* )* )
			DebugEnterAlt(1);
			// cs.g:1234:2: PP_AND_EXPRESSION ( TS )* ( '||' ( TS )* PP_AND_EXPRESSION ( TS )* )*
			{
			DebugLocation(1234, 2);
			mPP_AND_EXPRESSION(); 
			DebugLocation(1234, 22);
			// cs.g:1234:22: ( TS )*
			...
			DebugLocation(1234, 28);
			// cs.g:1234:28: ( '||' ( TS )* PP_AND_EXPRESSION ( TS )* )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// cs.g:1234:29: '||' ( TS )* PP_AND_EXPRESSION ( TS )*
					{
	...
	private void mPP_AND_EXPRESSION()
	{
		...
		try
		{
			// cs.g:1236:18: ( PP_EQUALITY_EXPRESSION ( TS )* ( '&&' ( TS )* PP_EQUALITY_EXPRESSION ( TS )* )* )
			DebugEnterAlt(1);
			// cs.g:1237:2: PP_EQUALITY_EXPRESSION ( TS )* ( '&&' ( TS )* PP_EQUALITY_EXPRESSION ( TS )* )*
			{
			DebugLocation(1237, 2);
			mPP_EQUALITY_EXPRESSION(); 
			DebugLocation(1237, 27);
			// cs.g:1237:27: ( TS )*
			...
			DebugLocation(1237, 33);
			// cs.g:1237:33: ( '&&' ( TS )* PP_EQUALITY_EXPRESSION ( TS )* )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// cs.g:1237:34: '&&' ( TS )* PP_EQUALITY_EXPRESSION ( TS )*
					{
	...
	private void mPP_EQUALITY_EXPRESSION()
	{
		...
		try
		{
			...
			// cs.g:1239:23: ( PP_UNARY_EXPRESSION ( TS )* ( ( '==' |ne= '!=' ) ( TS )* PP_UNARY_EXPRESSION ( TS )* )* )
			DebugEnterAlt(1);
			// cs.g:1240:2: PP_UNARY_EXPRESSION ( TS )* ( ( '==' |ne= '!=' ) ( TS )* PP_UNARY_EXPRESSION ( TS )* )*
			{
			...
			// cs.g:1240:30: ( ( '==' |ne= '!=' ) ( TS )* PP_UNARY_EXPRESSION ( TS )* )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// cs.g:1240:31: ( '==' |ne= '!=' ) ( TS )* PP_UNARY_EXPRESSION ( TS )*
					{
					DebugLocation(1240, 31);
					// cs.g:1240:31: ( '==' |ne= '!=' )
					int alt48=2;
					...
					case 2:
						...
						Match("!="); 
						int neStartLine2267 = Line;
						int neStartCharPos2267 = CharPositionInLine;
						ne = new CommonToken(input, TokenTypes.Invalid, TokenChannels.Default, neStart, CharIndex-1);
						ne.Line = neStartLine2267;
						ne.CharPositionInLine = neStartCharPos2267;
	...
	private void mPP_UNARY_EXPRESSION()
	{
		...
		try
		{
			...
			// cs.g:1248:20: (pe= PP_PRIMARY_EXPRESSION | '!' ( TS )* ue= PP_UNARY_EXPRESSION )
			int alt53=2;
			...
			case 1:
				DebugEnterAlt(1);
				// cs.g:1249:2: pe= PP_PRIMARY_EXPRESSION
				{
				DebugLocation(1249, 5);
				int peStart2304 = CharIndex;
				int peStartLine2304 = Line;
				int peStartCharPos2304 = CharPositionInLine;
				mPP_PRIMARY_EXPRESSION(); 
				pe = new CommonToken(input, TokenTypes.Invalid, TokenChannels.Default, peStart2304, CharIndex-1);
				pe.Line = peStartLine2304;
				pe.CharPositionInLine = peStartCharPos2304;

				}
				break;
			case 2:
				DebugEnterAlt(2);
				// cs.g:1250:4: '!' ( TS )* ue= PP_UNARY_EXPRESSION
				{
				DebugLocation(1250, 4);
				Match('!'); 
				DebugLocation(1250, 10);
				// cs.g:1250:10: ( TS )*
				...
				int ueStart2322 = CharIndex;
				int ueStartLine2322 = Line;
				int ueStartCharPos2322 = CharPositionInLine;
				mPP_UNARY_EXPRESSION(); 
				ue = new CommonToken(input, TokenTypes.Invalid, TokenChannels.Default, ueStart2322, CharIndex-1);
				ue.Line = ueStartLine2322;
				ue.CharPositionInLine = ueStartCharPos2322;
	...
	private void mPP_PRIMARY_EXPRESSION()
	{
		...
		try
		{
			...
			// cs.g:1253:22: ( IDENTIFIER | '(' PP_EXPRESSION ')' )
			int alt54=2;
			...
			case 1:
				DebugEnterAlt(1);
				// cs.g:1254:2: IDENTIFIER
				{
				DebugLocation(1254, 2);
				int IDENTIFIER1Start2337 = CharIndex;
				int IDENTIFIER1StartLine2337 = Line;
				int IDENTIFIER1StartCharPos2337 = CharPositionInLine;
				mIDENTIFIER(); 
				IDENTIFIER1 = new CommonToken(input, TokenTypes.Invalid, TokenChannels.Default, IDENTIFIER1Start2337, CharIndex-1);
				IDENTIFIER1.Line = IDENTIFIER1StartLine2337;
				IDENTIFIER1.CharPositionInLine = IDENTIFIER1StartCharPos2337;
	...
	private void mEscapeSequence()
	{
		...
		try
		{
			// cs.g:1271:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'v' | 'a' | '\\\"' | '\\'' | '\\\\' | ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) | 'x' HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT ) )
			DebugEnterAlt(1);
			// cs.g:1271:9: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'v' | 'a' | '\\\"' | '\\'' | '\\\\' | ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) | 'x' HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
			{
			DebugLocation(1271, 9);
			Match('\\'); 
			DebugLocation(1271, 14);
			// cs.g:1271:14: ( 'b' | 't' | 'n' | 'f' | 'r' | 'v' | 'a' | '\\\"' | '\\'' | '\\\\' | ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) | 'x' HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
			int alt55=19;
			...
			case '3':
				...
				if (((LA55_11>='0' && LA55_11<='7')))
				{
					int LA55_16 = input.LA(3);

					if (((LA55_16>='0' && LA55_16<='7')))
					{
						alt55 = 11;
					}
					else
			...
			case 'x':
				...
				if (((LA55_13>='0' && LA55_13<='9')||(LA55_13>='A' && LA55_13<='F')||(LA55_13>='a' && LA55_13<='f')))
				{
					int LA55_19 = input.LA(3);

					if (((LA55_19>='0' && LA55_19<='9')||(LA55_19>='A' && LA55_19<='F')||(LA55_19>='a' && LA55_19<='f')))
					{
						int LA55_22 = input.LA(4);

						if (((LA55_22>='0' && LA55_22<='9')||(LA55_22>='A' && LA55_22<='F')||(LA55_22>='a' && LA55_22<='f')))
						{
							int LA55_24 = input.LA(5);

							if (((LA55_24>='0' && LA55_24<='9')||(LA55_24>='A' && LA55_24<='F')||(LA55_24>='a' && LA55_24<='f')))
							{
								alt55 = 17;
							}
							else
			...
			case 15:
				DebugEnterAlt(15);
				// cs.g:1286:18: 'x' HEX_DIGIT HEX_DIGIT
				{
			...
			case 16:
				DebugEnterAlt(16);
				// cs.g:1287:18: 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
			...
			case 17:
				DebugEnterAlt(17);
				// cs.g:1288:18: 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
			...
			case 18:
				DebugEnterAlt(18);
				// cs.g:1289:18: 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
			...
			case 19:
				DebugEnterAlt(19);
				// cs.g:1290:18: 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
				...
				mHEX_DIGIT(); 
				DebugLocation(1290, 69);
				mHEX_DIGIT(); 
				DebugLocation(1290, 80);
				mHEX_DIGIT(); 
				DebugLocation(1290, 91);
				mHEX_DIGIT(); 
	...
	private void mDecimal_integer_literal()
	{
		...
		try
		{
			// cs.g:1293:24: ( Decimal_digits ( INTEGER_TYPE_SUFFIX )? )
			DebugEnterAlt(1);
			// cs.g:1294:2: Decimal_digits ( INTEGER_TYPE_SUFFIX )?
			{
			DebugLocation(1294, 2);
			mDecimal_digits(); 
			DebugLocation(1294, 19);
			// cs.g:1294:19: ( INTEGER_TYPE_SUFFIX )?
			int alt56=2;
	...
	private void mDecimal_digits()
	{
		...
		try
		{
			// cs.g:1299:15: ( ( DECIMAL_DIGIT )+ )
			DebugEnterAlt(1);
			// cs.g:1300:2: ( DECIMAL_DIGIT )+
			{
	...
	private void mINTEGER_TYPE_SUFFIX()
	{
		...
		try
		{
			// cs.g:1305:20: ( 'U' | 'u' | 'L' | 'l' | 'UL' | 'Ul' | 'uL' | 'ul' | 'LU' | 'Lu' | 'lU' | 'lu' )
			int alt59=12;
	...
	private void mExponent_part()
	{
		...
		try
		{
			// cs.g:1312:14: ( ( 'e' | 'E' ) ( Sign )? Decimal_digits )
			DebugEnterAlt(1);
			// cs.g:1313:2: ( 'e' | 'E' ) ( Sign )? Decimal_digits
			{
	...
	private class DFA23 : DFA
	{
		...
		public override string Description { get { return "1145:2: ( IF_TOKEN | DEFINE_TOKEN | ELSE_TOKEN | ENDIF_TOKEN | UNDEF_TOKEN )"; } }
	...
	private class DFA37 : DFA
	{
		...
		public override string Description { get { return "1177:2: ( '#' ( TS )* e= 'else' | '#' ( TS )* 'elif' ( TS )+ PP_EXPRESSION )"; } }
	...
	private class DFA62 : DFA
	{
		...
		private const string DFA62_specialS =
			"\x48\xFFFF\x1\x0\x66\xFFFF\x1\x2\x71\xFFFF\x1\x1\x17F\xFFFF}>";
		private static readonly string[] DFA62_transitionS =
			{
				...
				"\x1\xB5",
				"\x1\xB6",
				"\xA\x34\x7\xFFFF\x1A\x34\x4\xFFFF\x1\x34\x1\xFFFF\x2\x34\x1\xB7\xF"+
				"\x34\x1\xB8\x7\x34",
				"\x1\xBA",
				"\x1\xBB",
				"\x1\xBC",
	...
	private int SpecialStateTransition62(DFA dfa, int s, IIntStream _input)
	{
		...
		switch (s)
		{
			case 0:
				...
				else if (((LA62_72>='\u0000' && LA62_72<='.')||(LA62_72>='0' && LA62_72<='\uFFFF'))) {s = 176;}

				if (s >= 0) return s;
				break;

			case 1:
				int LA62_289 = input.LA(1);

				s = -1;
				if ((LA62_289=='\n'||LA62_289=='\r')) {s = 290;}

				else if (((LA62_289>='\u0000' && LA62_289<='\t')||(LA62_289>='\u000B' && LA62_289<='\f')||(LA62_289>='\u000E' && LA62_289<='\uFFFF'))) {s = 289;}
			...
			case 2:
				...
				s = -1;
				if (((LA62_175>='\u0000' && LA62_175<='\t')||(LA62_175>='\u000B' && LA62_175<='\f')||(LA62_175>='\u000E' && LA62_175<='\uFFFF'))) {s = 289;}
