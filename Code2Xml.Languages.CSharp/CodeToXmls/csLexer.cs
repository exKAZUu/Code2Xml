...
public partial class csLexer : Antlr.Runtime.Lexer
{
	...
	private void mSTRINGLITERAL()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// cs.g:1091:5: ( '\"' ( EscapeSequence |~ ( '\"' | '\\\\' ) )* '\"' )
			DebugEnterAlt(1);
			// cs.g:1092:5: '\"' ( EscapeSequence |~ ( '\"' | '\\\\' ) )* '\"'
			{
			DebugLocation(1092, 5);
			Match('\"'); 
			DebugLocation(1092, 9);
			// cs.g:1092:9: ( EscapeSequence |~ ( '\"' | '\\\\' ) )*
	...
	private void mVerbatim_string_literal()
	{
		...
		try
		{
			...
			DebugEnterAlt(1);
			// cs.g:1094:5: '@' '\"' ( Verbatim_string_literal_character )* '\"'
			{
			...
			// cs.g:1094:15: ( Verbatim_string_literal_character )*
	...
	private void mNUMBER()
	{
		...
		try
		{
			...
			DebugEnterAlt(1);
			// cs.g:1099:5: Decimal_digits ( INTEGER_TYPE_SUFFIX )?
			{
			DebugLocation(1099, 5);
			mDecimal_digits(); 
			DebugLocation(1099, 20);
			// cs.g:1099:20: ( INTEGER_TYPE_SUFFIX )?
			int alt9=2;
	...
	private void mGooBall()
	{
		...
		try
		{
			...
			// cs.g:1113:5: (dil= Decimal_integer_literal d= '.' s= GooBallIdentifier )
			DebugEnterAlt(1);
			// cs.g:1114:5: dil= Decimal_integer_literal d= '.' s= GooBallIdentifier
			{
	...
	private void mGooBallIdentifier()
	{
		...
		try
		{
			// cs.g:1118:5: ( IdentifierStart ( IdentifierPart )* )
			DebugEnterAlt(1);
			// cs.g:1118:7: IdentifierStart ( IdentifierPart )*
			{
			DebugLocation(1118, 7);
			mIdentifierStart(); 
			DebugLocation(1118, 23);
			// cs.g:1118:23: ( IdentifierPart )*
	...
	private void mReal_literal()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// cs.g:1121:13: ( Decimal_digits '.' Decimal_digits ( Exponent_part )? ( Real_type_suffix )? | '.' Decimal_digits ( Exponent_part )? ( Real_type_suffix )? | Decimal_digits Exponent_part ( Real_type_suffix )? | Decimal_digits Real_type_suffix )
			int alt16=4;
			...
			case 1:
				DebugEnterAlt(1);
				// cs.g:1122:5: Decimal_digits '.' Decimal_digits ( Exponent_part )? ( Real_type_suffix )?
				{
				...
				mDecimal_digits(); 
				DebugLocation(1122, 45);
				// cs.g:1122:45: ( Exponent_part )?
				int alt11=2;
				...
				DebugLocation(1122, 62);
				// cs.g:1122:62: ( Real_type_suffix )?
				int alt12=2;
			...
			case 2:
				DebugEnterAlt(2);
				// cs.g:1123:7: '.' Decimal_digits ( Exponent_part )? ( Real_type_suffix )?
				{
				...
				DebugLocation(1123, 47);
				// cs.g:1123:47: ( Real_type_suffix )?
				int alt14=2;
			...
			case 3:
				DebugEnterAlt(3);
				// cs.g:1124:7: Decimal_digits Exponent_part ( Real_type_suffix )?
				{
				DebugLocation(1124, 7);
				mDecimal_digits(); 
				DebugLocation(1124, 24);
				mExponent_part(); 
				DebugLocation(1124, 40);
				// cs.g:1124:40: ( Real_type_suffix )?
				int alt15=2;
			...
			case 4:
				DebugEnterAlt(4);
				// cs.g:1125:7: Decimal_digits Real_type_suffix
				{
	...
	private void mIDENTIFIER()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// cs.g:1135:11: ( IdentifierStart ( IdentifierPart )* )
			DebugEnterAlt(1);
			// cs.g:1136:5: IdentifierStart ( IdentifierPart )*
			{
			DebugLocation(1136, 5);
			mIdentifierStart(); 
			DebugLocation(1136, 21);
			// cs.g:1136:21: ( IdentifierPart )*
	...
	private void mPragma()
	{
		...
		try
		{
			int _type = Pragma;
			int _channel = DefaultTokenChannel;
			// cs.g:1137:7: ( '#' ( 'pragma' | 'region' | 'endregion' | 'line' | 'warning' | 'error' ) (~ ( '\\n' | '\\r' ) )* ( '\\r' | '\\n' )+ )
			DebugEnterAlt(1);
			// cs.g:1139:5: '#' ( 'pragma' | 'region' | 'endregion' | 'line' | 'warning' | 'error' ) (~ ( '\\n' | '\\r' ) )* ( '\\r' | '\\n' )+
			{
			DebugLocation(1139, 5);
			Match('#'); 
			DebugLocation(1139, 9);
			// cs.g:1139:9: ( 'pragma' | 'region' | 'endregion' | 'line' | 'warning' | 'error' )
			int alt19=6;
			...
			case 3:
				DebugEnterAlt(3);
				// cs.g:1139:32: 'endregion'
				{
				DebugLocation(1139, 32);
				Match("endregion"); 
			...
			case 5:
				DebugEnterAlt(5);
				// cs.g:1139:55: 'warning'
				{
				DebugLocation(1139, 55);
				Match("warning"); 
	...
	private void mPP_CONDITIONAL()
	{
		...
		try
		{
			// cs.g:1145:15: ( ( IF_TOKEN | DEFINE_TOKEN | ELSE_TOKEN | ENDIF_TOKEN | UNDEF_TOKEN ) ( TS )* ( ( LINE_COMMENT )? | ( '\\r' | '\\n' )+ ) )
			DebugEnterAlt(1);
			// cs.g:1146:5: ( IF_TOKEN | DEFINE_TOKEN | ELSE_TOKEN | ENDIF_TOKEN | UNDEF_TOKEN ) ( TS )* ( ( LINE_COMMENT )? | ( '\\r' | '\\n' )+ )
			{
			DebugLocation(1146, 5);
			// cs.g:1146:5: ( IF_TOKEN | DEFINE_TOKEN | ELSE_TOKEN | ENDIF_TOKEN | UNDEF_TOKEN )
			int alt23=5;
			...
			case 1:
				DebugEnterAlt(1);
				// cs.g:1146:6: IF_TOKEN
				{
				DebugLocation(1146, 6);
				mIF_TOKEN(); 
			...
			DebugLocation(1150, 28);
			// cs.g:1150:28: ( ( LINE_COMMENT )? | ( '\\r' | '\\n' )+ )
			int alt27=2;
	...
	private void mIF_TOKEN()
	{
		...
		try
		{
			CommonToken ppe = default(CommonToken);
			 ...
			 bool process = true; 
			// cs.g:1153:35: ( ( '#' ( TS )* 'if' ( TS )+ ppe= PP_EXPRESSION ) )
			DebugEnterAlt(1);
			// cs.g:1154:5: ( '#' ( TS )* 'if' ( TS )+ ppe= PP_EXPRESSION )
			{
			DebugLocation(1154, 5);
			// cs.g:1154:5: ( '#' ( TS )* 'if' ( TS )+ ppe= PP_EXPRESSION )
			DebugEnterAlt(1);
			// cs.g:1154:6: '#' ( TS )* 'if' ( TS )+ ppe= PP_EXPRESSION
			{
			...
			DebugLocation(1154, 17);
			Match("if"); 

			DebugLocation(1154, 24);
			// cs.g:1154:24: ( TS )+
			int cnt29=0;
			...
			DebugLocation(1154, 34);
			int ppeStart2081 = CharIndex;
			int ppeStartLine2081 = Line;
			int ppeStartCharPos2081 = CharPositionInLine;
			mPP_EXPRESSION(); 
			ppe = new CommonToken(input, TokenTypes.Invalid, TokenChannels.Default, ppeStart2081, CharIndex-1);
			ppe.Line = ppeStartLine2081;
			ppe.CharPositionInLine = ppeStartCharPos2081;
	...
	private void mDEFINE_TOKEN()
	{
		...
		try
		{
			...
			// cs.g:1164:13: ( '#' ( TS )* 'define' ( TS )+ define= IDENTIFIER )
			DebugEnterAlt(1);
			// cs.g:1165:5: '#' ( TS )* 'define' ( TS )+ define= IDENTIFIER
			{
			DebugLocation(1165, 5);
			Match('#'); 
			DebugLocation(1165, 11);
			// cs.g:1165:11: ( TS )*
	...
	private void mUNDEF_TOKEN()
	{
		...
		try
		{
			...
			// cs.g:1170:12: ( '#' ( TS )* 'undef' ( TS )+ define= IDENTIFIER )
			DebugEnterAlt(1);
			// cs.g:1171:5: '#' ( TS )* 'undef' ( TS )+ define= IDENTIFIER
			{
			DebugLocation(1171, 5);
			Match('#'); 
			DebugLocation(1171, 11);
			// cs.g:1171:11: ( TS )*
			...
			DebugLocation(1171, 40);
			int defineStart2160 = CharIndex;
			int defineStartLine2160 = Line;
			int defineStartCharPos2160 = CharPositionInLine;
			mIDENTIFIER(); 
			define = new CommonToken(input, TokenTypes.Invalid, TokenChannels.Default, defineStart2160, CharIndex-1);
			define.Line = defineStartLine2160;
			define.CharPositionInLine = defineStartCharPos2160;
	...
	private void mELSE_TOKEN()
	{
		...
		try
		{
			...
			// cs.g:1177:11: ( ( '#' ( TS )* e= 'else' | '#' ( TS )* 'elif' ( TS )+ PP_EXPRESSION ) )
			DebugEnterAlt(1);
			// cs.g:1178:5: ( '#' ( TS )* e= 'else' | '#' ( TS )* 'elif' ( TS )+ PP_EXPRESSION )
			{
			...
			case 1:
				DebugEnterAlt(1);
				// cs.g:1178:7: '#' ( TS )* e= 'else'
				{
				DebugLocation(1178, 7);
				Match('#'); 
				...
				DebugLocation(1178, 21);
				int eStart = CharIndex;
				Match("else"); 
				int eStartLine2194 = Line;
				int eStartCharPos2194 = CharPositionInLine;
				e = new CommonToken(input, TokenTypes.Invalid, TokenChannels.Default, eStart, CharIndex-1);
				e.Line = eStartLine2194;
				e.CharPositionInLine = eStartCharPos2194;

				}
				break;
			case 2:
				DebugEnterAlt(2);
				// cs.g:1179:7: '#' ( TS )* 'elif' ( TS )+ PP_EXPRESSION
				{
				...
				DebugLocation(1179, 19);
				Match("elif"); 

				DebugLocation(1179, 28);
				// cs.g:1179:28: ( TS )+
				int cnt36=0;
	...
	private void mPP_EXPRESSION()
	{
		...
		try
		{
			// cs.g:1231:14: ( PP_OR_EXPRESSION )
			DebugEnterAlt(1);
			// cs.g:1232:5: PP_OR_EXPRESSION
			{
	...
	private void mPP_OR_EXPRESSION()
	{
		...
		try
		{
			// cs.g:1234:17: ( PP_AND_EXPRESSION ( TS )* ( '||' ( TS )* PP_AND_EXPRESSION ( TS )* )* )
			DebugEnterAlt(1);
			// cs.g:1235:5: PP_AND_EXPRESSION ( TS )* ( '||' ( TS )* PP_AND_EXPRESSION ( TS )* )*
			{
			DebugLocation(1235, 5);
			mPP_AND_EXPRESSION(); 
			DebugLocation(1235, 25);
			// cs.g:1235:25: ( TS )*
			...
			DebugLocation(1235, 31);
			// cs.g:1235:31: ( '||' ( TS )* PP_AND_EXPRESSION ( TS )* )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// cs.g:1235:32: '||' ( TS )* PP_AND_EXPRESSION ( TS )*
					{
	...
	private void mPP_AND_EXPRESSION()
	{
		...
		try
		{
			// cs.g:1237:18: ( PP_EQUALITY_EXPRESSION ( TS )* ( '&&' ( TS )* PP_EQUALITY_EXPRESSION ( TS )* )* )
			DebugEnterAlt(1);
			// cs.g:1238:5: PP_EQUALITY_EXPRESSION ( TS )* ( '&&' ( TS )* PP_EQUALITY_EXPRESSION ( TS )* )*
			{
			...
			// cs.g:1238:36: ( '&&' ( TS )* PP_EQUALITY_EXPRESSION ( TS )* )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// cs.g:1238:37: '&&' ( TS )* PP_EQUALITY_EXPRESSION ( TS )*
					{
					DebugLocation(1238, 37);
					Match("&&"); 

					DebugLocation(1238, 44);
					// cs.g:1238:44: ( TS )*
					...
					DebugLocation(1238, 50);
					mPP_EQUALITY_EXPRESSION(); 
					DebugLocation(1238, 75);
					// cs.g:1238:75: ( TS )*
	...
	private void mPP_EQUALITY_EXPRESSION()
	{
		...
		try
		{
			...
			// cs.g:1240:23: ( PP_UNARY_EXPRESSION ( TS )* ( ( '==' |ne= '!=' ) ( TS )* PP_UNARY_EXPRESSION ( TS )* )* )
			DebugEnterAlt(1);
			// cs.g:1241:5: PP_UNARY_EXPRESSION ( TS )* ( ( '==' |ne= '!=' ) ( TS )* PP_UNARY_EXPRESSION ( TS )* )*
			{
			...
			// cs.g:1241:33: ( ( '==' |ne= '!=' ) ( TS )* PP_UNARY_EXPRESSION ( TS )* )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// cs.g:1241:34: ( '==' |ne= '!=' ) ( TS )* PP_UNARY_EXPRESSION ( TS )*
					{
					...
					case 2:
						...
						// cs.g:1241:41: ne= '!='
						{
						DebugLocation(1241, 44);
						int neStart = CharIndex;
						Match("!="); 
						int neStartLine2373 = Line;
						int neStartCharPos2373 = CharPositionInLine;
						ne = new CommonToken(input, TokenTypes.Invalid, TokenChannels.Default, neStart, CharIndex-1);
						ne.Line = neStartLine2373;
						ne.CharPositionInLine = neStartCharPos2373;
	...
	private void mPP_UNARY_EXPRESSION()
	{
		...
		try
		{
			...
			// cs.g:1249:20: (pe= PP_PRIMARY_EXPRESSION | '!' ( TS )* ue= PP_UNARY_EXPRESSION )
			int alt52=2;
			...
			case 1:
				DebugEnterAlt(1);
				// cs.g:1250:5: pe= PP_PRIMARY_EXPRESSION
				{
				DebugLocation(1250, 8);
				int peStart2428 = CharIndex;
				int peStartLine2428 = Line;
				int peStartCharPos2428 = CharPositionInLine;
				mPP_PRIMARY_EXPRESSION(); 
				pe = new CommonToken(input, TokenTypes.Invalid, TokenChannels.Default, peStart2428, CharIndex-1);
				pe.Line = peStartLine2428;
				pe.CharPositionInLine = peStartCharPos2428;

				}
				break;
			case 2:
				DebugEnterAlt(2);
				// cs.g:1251:7: '!' ( TS )* ue= PP_UNARY_EXPRESSION
				{
				...
				DebugLocation(1251, 22);
				int ueStart2449 = CharIndex;
				int ueStartLine2449 = Line;
				int ueStartCharPos2449 = CharPositionInLine;
				mPP_UNARY_EXPRESSION(); 
				ue = new CommonToken(input, TokenTypes.Invalid, TokenChannels.Default, ueStart2449, CharIndex-1);
				ue.Line = ueStartLine2449;
				ue.CharPositionInLine = ueStartCharPos2449;
	...
	private void mPP_PRIMARY_EXPRESSION()
	{
		...
		try
		{
			...
			// cs.g:1254:22: ( IDENTIFIER | '(' PP_EXPRESSION ')' )
			int alt53=2;
			...
			case 1:
				DebugEnterAlt(1);
				// cs.g:1255:5: IDENTIFIER
				{
				DebugLocation(1255, 5);
				int IDENTIFIER1Start2470 = CharIndex;
				int IDENTIFIER1StartLine2470 = Line;
				int IDENTIFIER1StartCharPos2470 = CharPositionInLine;
				mIDENTIFIER(); 
				IDENTIFIER1 = new CommonToken(input, TokenTypes.Invalid, TokenChannels.Default, IDENTIFIER1Start2470, CharIndex-1);
				IDENTIFIER1.Line = IDENTIFIER1StartLine2470;
				IDENTIFIER1.CharPositionInLine = IDENTIFIER1StartCharPos2470;
	...
	private void mEscapeSequence()
	{
		...
		try
		{
			// cs.g:1272:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'v' | 'a' | '\\\"' | '\\'' | '\\\\' | ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) | 'x' HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT ) )
			DebugEnterAlt(1);
			// cs.g:1272:9: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'v' | 'a' | '\\\"' | '\\'' | '\\\\' | ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) | 'x' HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
			{
			DebugLocation(1272, 9);
			Match('\\'); 
			DebugLocation(1272, 14);
			// cs.g:1272:14: ( 'b' | 't' | 'n' | 'f' | 'r' | 'v' | 'a' | '\\\"' | '\\'' | '\\\\' | ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) | 'x' HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
			int alt54=19;
			...
			case 15:
				DebugEnterAlt(15);
				// cs.g:1287:18: 'x' HEX_DIGIT HEX_DIGIT
				{
			...
			case 16:
				DebugEnterAlt(16);
				// cs.g:1288:18: 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
			...
			case 17:
				DebugEnterAlt(17);
				// cs.g:1289:18: 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
			...
			case 18:
				DebugEnterAlt(18);
				// cs.g:1290:18: 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
			...
			case 19:
				DebugEnterAlt(19);
				// cs.g:1291:18: 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
				...
				mHEX_DIGIT(); 
				DebugLocation(1291, 69);
				mHEX_DIGIT(); 
				DebugLocation(1291, 80);
				mHEX_DIGIT(); 
				DebugLocation(1291, 91);
				mHEX_DIGIT(); 
	...
	private void mDecimal_integer_literal()
	{
		...
		try
		{
			// cs.g:1294:24: ( Decimal_digits ( INTEGER_TYPE_SUFFIX )? )
			DebugEnterAlt(1);
			// cs.g:1295:5: Decimal_digits ( INTEGER_TYPE_SUFFIX )?
			{
			DebugLocation(1295, 5);
			mDecimal_digits(); 
			DebugLocation(1295, 22);
			// cs.g:1295:22: ( INTEGER_TYPE_SUFFIX )?
			int alt55=2;
	...
	private void mHex_number()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// cs.g:1296:11: ( '0' ( 'x' | 'X' ) HEX_DIGITS ( INTEGER_TYPE_SUFFIX )? )
			DebugEnterAlt(1);
			// cs.g:1297:5: '0' ( 'x' | 'X' ) HEX_DIGITS ( INTEGER_TYPE_SUFFIX )?
			{
			...
			DebugLocation(1297, 20);
			mHEX_DIGITS(); 
			DebugLocation(1297, 33);
			// cs.g:1297:33: ( INTEGER_TYPE_SUFFIX )?
			int alt56=2;
	...
	private void mDecimal_digits()
	{
		...
		try
		{
			// cs.g:1300:15: ( ( DECIMAL_DIGIT )+ )
			DebugEnterAlt(1);
			// cs.g:1301:5: ( DECIMAL_DIGIT )+
			{
	...
	private void mINTEGER_TYPE_SUFFIX()
	{
		...
		try
		{
			// cs.g:1306:20: ( 'U' | 'u' | 'L' | 'l' | 'UL' | 'Ul' | 'uL' | 'ul' | 'LU' | 'Lu' | 'lU' | 'lu' )
			int alt58=12;
	...
	private void mHEX_DIGITS()
	{
		...
		try
		{
			// cs.g:1307:20: ( ( HEX_DIGIT )+ )
			DebugEnterAlt(1);
			// cs.g:1308:5: ( HEX_DIGIT )+
			{
	...
	private void mExponent_part()
	{
		...
		try
		{
			// cs.g:1313:14: ( ( 'e' | 'E' ) ( Sign )? Decimal_digits )
			DebugEnterAlt(1);
			// cs.g:1314:5: ( 'e' | 'E' ) ( Sign )? Decimal_digits
			{
	...
	private class DFA16 : DFA
	{
		...
		public override string Description { get { return "1121:1: Real_literal : ( Decimal_digits '.' Decimal_digits ( Exponent_part )? ( Real_type_suffix )? | '.' Decimal_digits ( Exponent_part )? ( Real_type_suffix )? | Decimal_digits Exponent_part ( Real_type_suffix )? | Decimal_digits Real_type_suffix );"; } }
	...
	private class DFA23 : DFA
	{
		...
		public override string Description { get { return "1146:5: ( IF_TOKEN | DEFINE_TOKEN | ELSE_TOKEN | ENDIF_TOKEN | UNDEF_TOKEN )"; } }
	...
	private class DFA37 : DFA
	{
		...
		public override string Description { get { return "1178:5: ( '#' ( TS )* e= 'else' | '#' ( TS )* 'elif' ( TS )+ PP_EXPRESSION )"; } }
