...
public partial class LuaLexer : Antlr.Runtime.Lexer
{
	...
	private void mEscapeSequence()
	{
		...
		try
		{
			// Lua.g:129:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UnicodeEscape | OctalEscape )
			int alt11=3;
	...
	private void mOctalEscape()
	{
		...
		try
		{
			// Lua.g:136:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
			int alt12=3;
	...
	private void mUnicodeEscape()
	{
		...
		try
		{
			// Lua.g:143:5: ( '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit )
			DebugEnterAlt(1);
			// Lua.g:143:9: '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit
			{
			DebugLocation(143, 9);
			Match('\\'); 
	...
	private class DFA17 : DFA
	{
		private const string DFA17_eotS =
			...
			"\x2\xFFFF\x2\x23\x1\x84\x1\x85\x2\x23\x3\xFFFF\x1\x4E\x1\xFFFF\x1\x8A"+
			"\x1\x23\x1\xFFFF\x1\x8C\x1\x23\x1\x8E\x2\x23\x2\xFFFF\x1\x91\x1\x92\x1"+
			"\x89\x2\xFFFF\x1\x93\x1\xFFFF\x1\x23\x1\xFFFF\x1\x95\x1\x96\x3\xFFFF"+
			"\x1\x23\x2\xFFFF\x1\x98\x1\xFFFF";
		...
		private const string DFA17_minS =
			...
			"\x2\x30\x1\x0\x2\xFFFF\x1\x30\x1\xFFFF\x1\x6F\x1\xFFFF\x2\x30\x3\xFFFF"+
			"\x1\x6E\x2\xFFFF\x1\x30\x1\xFFFF";
		private const string DFA17_maxS =
			...
			"\x74\x1\x6E\x2\xFFFF\x2\x7A\x1\xFFFF\x2\xFFFF\x1\x7A\x1\xFFFF\x1\x6F"+
			"\x1\xFFFF\x2\x7A\x3\xFFFF\x1\x6E\x2\xFFFF\x1\x7A\x1\xFFFF";
		private const string DFA17_acceptS =
			...
			"\x5\xFFFF\x1\x29\x1\x2A\x3\xFFFF\x1\x38\x1\x19\x1\xFFFF\x1\x1E\x1\xFFFF"+
			"\x1\x23\x2\xFFFF\x1\x2B\x1\x2C\x1\x1C\x1\xFFFF\x1\x27\x1\x28\x1\xFFFF"+
			"\x1\x20";
		private const string DFA17_specialS =
			"\x2A\xFFFF\x1\x1\x22\xFFFF\x1\x4\x18\xFFFF\x1\x2\x11\xFFFF\x1\x7\x1\x0"+
			"\x1\x5\x1\x6\xC\xFFFF\x1\x3\x10\xFFFF}>";
		private static readonly string[] DFA17_transitionS =
			{
				...
				"",
				"",
				"\x1\x4B\x1\xFFFF\xA\x25\xB\xFFFF\x1\x4C\x1F\xFFFF\x1\x4C\x12\xFFFF"+
				"\x1\x49",
	...
	private int SpecialStateTransition17(DFA dfa, int s, IIntStream _input)
	{
		...
		switch (s)
		{
			case 0:
				...
				s = -1;
				if (((LA17_121>='\u0000' && LA17_121<='\t')||(LA17_121>='\u000B' && LA17_121<='\uFFFF'))) {s = 137;}
			...
			case 1:
				...
				else if (((LA17_42>='\u0000' && LA17_42<='Z')||(LA17_42>='\\' && LA17_42<='\uFFFF'))) {s = 78;}
			...
			case 2:
				...
				else if ((LA17_102=='\r')) {s = 121;}

				else if ((LA17_102=='\n')) {s = 122;}

				else if (((LA17_102>='\u0000' && LA17_102<='\t')||(LA17_102>='\u000B' && LA17_102<='\f')||(LA17_102>='\u000E' && LA17_102<='\\')||(LA17_102>='^' && LA17_102<='\uFFFF'))) {s = 123;}
			...
			case 3:
				...
				else if ((LA17_136=='\r')) {s = 121;}

				else if ((LA17_136=='\n')) {s = 122;}

				else if (((LA17_136>='\u0000' && LA17_136<='\t')||(LA17_136>='\u000B' && LA17_136<='\f')||(LA17_136>='\u000E' && LA17_136<='\\')||(LA17_136>='^' && LA17_136<='\uFFFF'))) {s = 123;}
			...
			case 4:
				...
				else if (((LA17_77>='\u0000' && LA17_77<='Z')||(LA17_77>='\\' && LA17_77<='\uFFFF'))) {s = 78;}
			...
			case 6:
				...
				else if ((LA17_123=='\r')) {s = 121;}

				else if ((LA17_123=='\n')) {s = 122;}

				else if (((LA17_123>='\u0000' && LA17_123<='\t')||(LA17_123>='\u000B' && LA17_123<='\f')||(LA17_123>='\u000E' && LA17_123<='\\')||(LA17_123>='^' && LA17_123<='\uFFFF'))) {s = 123;}
			...
			case 7:
				...
				else if ((LA17_120=='\r')) {s = 121;}

				else if ((LA17_120=='\n')) {s = 122;}

				else if (((LA17_120>='\u0000' && LA17_120<='\t')||(LA17_120>='\u000B' && LA17_120<='\f')||(LA17_120>='\u000E' && LA17_120<='\\')||(LA17_120>='^' && LA17_120<='\uFFFF'))) {s = 123;}
