...
namespace Code2Xml.Languages.ExternalGenerators.Generators.Ruby {
    /// <summary>
    /// Represents a Ruby 2.0.x CstGenerator for inter-converting between source code and XML-based ASTs.
    /// </summary>
    [Export(typeof(AstGenerator))]
    public class Ruby20AstGenerator : AstGeneratorUsingExternalProgram {
        ...
        private string ProcessorPath {
            ...
            set {
                ...
                ParaibaFile.WriteIfDifferentSize(
                        PrivateXmlGeneratorArguments[0], Resources.ruby202xml);
                ParaibaFile.WriteIfDifferentSize(
                        PrivateCodeGeneratorArguments[0], Resources.xml2ruby20);
                RubyFiles.DeployCommonFiles(DirectoryPath);
            }
        }

        public Ruby20AstGenerator()
                : this(null) {}

        public Ruby20AstGenerator(string processorPath)
                : base(".rb") {
