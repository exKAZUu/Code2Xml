...
namespace Code2Xml.Languages.ANTLRv4.Generators.Verilog2001 {
    /// <summary>
    /// Represents a Verilog2001 parser and a Verilog2001 code generator.
    /// </summary>
    [Export(typeof(CstGenerator))]
    public class Verilog2001CstGenerator : CstGeneratorUsingAntlr4<Verilog2001Parser> {
        /// <summary>
        ...
        public Verilog2001CstGenerator() : base(".v") {}
