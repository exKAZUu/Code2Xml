...
namespace Code2Xml.Languages.ANTLRv3.Core {
	public class Antlr3AstBuilder : CommonTreeAdaptor {
		...
		public void AddChild(
				object t, object child, Antlr3AstNode target, string id, Antlr3AstNode parent) {
			parent.Element.Add(target.Element);
			var num = id.StartsWith(target.Element.Name())
					? id.Substring(target.Element.Name().length())
					: id;
