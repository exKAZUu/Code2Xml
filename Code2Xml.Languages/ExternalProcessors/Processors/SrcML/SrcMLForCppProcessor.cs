...
namespace Code2Xml.Languages.ExternalProcessors.Processors.SrcML {
    /// <summary>
    /// Represents a C++ processor using SrcML for inter-converting between source code and XML-based ASTs.
    /// </summary>
    // [Export(typeof(Processor))] // because this class is under experiment
    public class SrcMLForCppProcessor : ProcessorUsingExternalProcessor {
