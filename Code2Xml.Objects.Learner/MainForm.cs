...
using Code2Xml.Objects.Tests.Learning;
	...
	public partial class MainForm : Form {
		...
		private void MainForm_Load(object sender, EventArgs e) {
			...
			foreach (var processor in processors) {
				var menuItem =
						menuItemLanguage.DropDownItems.Add(processor.LanguageNameWithVersion) as ToolStripMenuItem;
		...
		private void DrawMarkers(
				IEnumerable<KeyValuePair<CodeRange, CstNode>> range2Elements, params int[] markingIds) {
