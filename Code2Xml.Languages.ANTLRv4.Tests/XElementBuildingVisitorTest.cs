...
namespace Code2Xml.Languages.ANTLRv4.Tests {
	[TestFixture]
	public class XElementBuildingVisitorTest {
		[Test]
		public void ParseC() {
...
int main(int argc, char **args) {
	...
	return 0;
			...
			var visitor = new XElementBuildingVisitor(parser, true);
			visitor.Visit(context);
			Console.WriteLine(visitor.Root);
		}
...
");
			...
			var context = parser.source_text();
			var visitor = new XElementBuildingVisitor(parser, true);
			visitor.Visit(context);
			Console.WriteLine(visitor.Root);
		}
