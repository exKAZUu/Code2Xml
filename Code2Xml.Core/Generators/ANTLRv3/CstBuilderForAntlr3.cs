...
namespace Code2Xml.Core.Generators.ANTLRv3 {
    public class CstBuilderForAntlr3 : CommonTreeAdaptor {
        private readonly CommonTokenStream _stream;
        private readonly string[] _tokenNames;
        private int _nextTokenIndex;

        public CstBuilderForAntlr3() {} // for parser generated by ANTLR 3

        public CstBuilderForAntlr3(CommonTokenStream stream, string[] tokenNames) {
            _stream = stream;
