...
// $ANTLR 3.5.0.2 cs.g 2013-10-04 14:55:15
...
public partial class csLexer : Antlr.Runtime.Lexer
{
	...
	private void mT__117()
	{
		...
		try
		{
			int _type = T__117;
			int _channel = DefaultTokenChannel;
			// cs.g:80:8: ( 'descending' )
			DebugEnterAlt(1);
			// cs.g:80:10: 'descending'
			{
			DebugLocation(80, 10);
			Match("descending"); 
	...
	private void mT__139()
	{
		...
		try
		{
			int _type = T__139;
			int _channel = DefaultTokenChannel;
			// cs.g:102:8: ( 'interface' )
			DebugEnterAlt(1);
			// cs.g:102:10: 'interface'
			{
	...
	private void mT__149()
	{
		...
		try
		{
			int _type = T__149;
			int _channel = DefaultTokenChannel;
			// cs.g:112:8: ( 'namespace' )
			DebugEnterAlt(1);
			// cs.g:112:10: 'namespace'
			{
	...
	private void mT__163()
	{
		...
		try
		{
			int _type = T__163;
			int _channel = DefaultTokenChannel;
			// cs.g:126:8: ( 'protected' )
			DebugEnterAlt(1);
			// cs.g:126:10: 'protected'
			{
	...
	private void mT__187()
	{
		...
		try
		{
			int _type = T__187;
			int _channel = DefaultTokenChannel;
			// cs.g:150:8: ( 'unchecked' )
			DebugEnterAlt(1);
			// cs.g:150:10: 'unchecked'
			{
	...
	private void mCOMMENT()
	{
		...
		try
		{
			int _type = COMMENT;
			int _channel = DefaultTokenChannel;
			// cs.g:1096:8: ( '/*' ( options {greedy=false; } : . )* '*/' )
			DebugEnterAlt(1);
			// cs.g:1097:4: '/*' ( options {greedy=false; } : . )* '*/'
			{
			DebugLocation(1097, 4);
			Match("/*"); 

			DebugLocation(1098, 4);
			// cs.g:1098:4: ( options {greedy=false; } : . )*
	...
	private void mSTRINGLITERAL()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// cs.g:1102:2: ( '\"' ( EscapeSequence |~ ( '\"' | '\\\\' ) )* '\"' )
			DebugEnterAlt(1);
			// cs.g:1103:2: '\"' ( EscapeSequence |~ ( '\"' | '\\\\' ) )* '\"'
			{
			DebugLocation(1103, 2);
			Match('\"'); 
			DebugLocation(1103, 6);
			// cs.g:1103:6: ( EscapeSequence |~ ( '\"' | '\\\\' ) )*
	...
	private void mVerbatim_string_literal()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// cs.g:1104:24: ( '@' '\"' ( Verbatim_string_literal_character )* '\"' )
			DebugEnterAlt(1);
			// cs.g:1105:2: '@' '\"' ( Verbatim_string_literal_character )* '\"'
			{
			...
			// cs.g:1105:12: ( Verbatim_string_literal_character )*
	...
	private void mNUMBER()
	{
		...
		try
		{
			int _type = NUMBER;
			int _channel = DefaultTokenChannel;
			// cs.g:1109:7: ( Decimal_digits ( INTEGER_TYPE_SUFFIX )? )
			DebugEnterAlt(1);
			// cs.g:1110:2: Decimal_digits ( INTEGER_TYPE_SUFFIX )?
			{
			DebugLocation(1110, 2);
			mDecimal_digits(); 
			DebugLocation(1110, 17);
			// cs.g:1110:17: ( INTEGER_TYPE_SUFFIX )?
			int alt9=2;
	...
	private void mGooBall()
	{
		...
		try
		{
			...
			// cs.g:1124:2: (dil= Decimal_integer_literal d= '.' s= GooBallIdentifier )
			DebugEnterAlt(1);
			// cs.g:1125:2: dil= Decimal_integer_literal d= '.' s= GooBallIdentifier
			{
			DebugLocation(1125, 6);
			...
			DebugLocation(1125, 34);

			d = input.LA(1);

			Match('.'); 
			DebugLocation(1125, 41);
	...
	private void mGooBallIdentifier()
	{
		...
		try
		{
			// cs.g:1129:2: ( IdentifierStart ( IdentifierPart )* )
			DebugEnterAlt(1);
			// cs.g:1129:4: IdentifierStart ( IdentifierPart )*
			{
			DebugLocation(1129, 4);
			mIdentifierStart(); 
			DebugLocation(1129, 20);
			// cs.g:1129:20: ( IdentifierPart )*
	...
	private void mReal_literal()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// cs.g:1132:13: ( Decimal_digits '.' Decimal_digits ( Exponent_part )? ( Real_type_suffix )? | '.' Decimal_digits ( Exponent_part )? ( Real_type_suffix )? | Decimal_digits Exponent_part ( Real_type_suffix )? | Decimal_digits Real_type_suffix )
			int alt16=4;
			...
			case 1:
				DebugEnterAlt(1);
				// cs.g:1133:2: Decimal_digits '.' Decimal_digits ( Exponent_part )? ( Real_type_suffix )?
				{
				DebugLocation(1133, 2);
				mDecimal_digits(); 
				DebugLocation(1133, 19);
				Match('.'); 
				DebugLocation(1133, 25);
				mDecimal_digits(); 
				DebugLocation(1133, 42);
				// cs.g:1133:42: ( Exponent_part )?
				int alt11=2;
				...
				DebugLocation(1133, 59);
				// cs.g:1133:59: ( Real_type_suffix )?
				int alt12=2;
			...
			case 2:
				DebugEnterAlt(2);
				// cs.g:1134:4: '.' Decimal_digits ( Exponent_part )? ( Real_type_suffix )?
				{
			...
			case 3:
				DebugEnterAlt(3);
				// cs.g:1135:4: Decimal_digits Exponent_part ( Real_type_suffix )?
				{
				DebugLocation(1135, 4);
				mDecimal_digits(); 
				DebugLocation(1135, 21);
				mExponent_part(); 
				DebugLocation(1135, 37);
				// cs.g:1135:37: ( Real_type_suffix )?
				int alt15=2;
			...
			case 4:
				DebugEnterAlt(4);
				// cs.g:1136:4: Decimal_digits Real_type_suffix
				{
	...
	private void mCharacter_literal()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// cs.g:1137:18: ( '\\'' ( EscapeSequence |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ) '\\'' )
			DebugEnterAlt(1);
			// cs.g:1138:2: '\\'' ( EscapeSequence |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ) '\\''
			{
			DebugLocation(1138, 2);
			Match('\''); 
			DebugLocation(1139, 5);
			// cs.g:1139:5: ( EscapeSequence |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) )
			int alt17=4;
	...
	private void mIDENTIFIER()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// cs.g:1146:11: ( IdentifierStart ( IdentifierPart )* )
			DebugEnterAlt(1);
			// cs.g:1147:5: IdentifierStart ( IdentifierPart )*
			{
			DebugLocation(1147, 5);
			mIdentifierStart(); 
			DebugLocation(1147, 21);
			// cs.g:1147:21: ( IdentifierPart )*
	...
	private void mPragma()
	{
		...
		try
		{
			int _type = Pragma;
			int _channel = DefaultTokenChannel;
			// cs.g:1148:7: ( '#' ( 'pragma' | 'region' | 'endregion' | 'line' | 'warning' | 'error' ) (~ ( '\\n' | '\\r' ) )* ( '\\r' | '\\n' )+ )
			DebugEnterAlt(1);
			// cs.g:1150:2: '#' ( 'pragma' | 'region' | 'endregion' | 'line' | 'warning' | 'error' ) (~ ( '\\n' | '\\r' ) )* ( '\\r' | '\\n' )+
			{
			DebugLocation(1150, 2);
			Match('#'); 
			DebugLocation(1150, 6);
			// cs.g:1150:6: ( 'pragma' | 'region' | 'endregion' | 'line' | 'warning' | 'error' )
			int alt19=6;
			...
			case 3:
				DebugEnterAlt(3);
				// cs.g:1150:29: 'endregion'
				{
				DebugLocation(1150, 29);
				Match("endregion"); 
	...
	private void mPP_CONDITIONAL()
	{
		...
		try
		{
			// cs.g:1156:15: ( ( IF_TOKEN | DEFINE_TOKEN | ELSE_TOKEN | ENDIF_TOKEN | UNDEF_TOKEN ) ( TS )* ( ( LINE_COMMENT )? | ( '\\r' | '\\n' )+ ) )
			DebugEnterAlt(1);
			// cs.g:1157:2: ( IF_TOKEN | DEFINE_TOKEN | ELSE_TOKEN | ENDIF_TOKEN | UNDEF_TOKEN ) ( TS )* ( ( LINE_COMMENT )? | ( '\\r' | '\\n' )+ )
			{
			DebugLocation(1157, 2);
			// cs.g:1157:2: ( IF_TOKEN | DEFINE_TOKEN | ELSE_TOKEN | ENDIF_TOKEN | UNDEF_TOKEN )
			int alt23=5;
	...
	private void mIF_TOKEN()
	{
		...
		try
		{
			CommonToken ppe = default(CommonToken);
			 ...
			 bool process = true; 
			// cs.g:1164:32: ( ( '#' ( TS )* 'if' ( TS )+ ppe= PP_EXPRESSION ) )
			DebugEnterAlt(1);
			// cs.g:1165:2: ( '#' ( TS )* 'if' ( TS )+ ppe= PP_EXPRESSION )
			{
			DebugLocation(1165, 2);
			// cs.g:1165:2: ( '#' ( TS )* 'if' ( TS )+ ppe= PP_EXPRESSION )
			DebugEnterAlt(1);
			// cs.g:1165:3: '#' ( TS )* 'if' ( TS )+ ppe= PP_EXPRESSION
			{
	...
	private void mDEFINE_TOKEN()
	{
		...
		try
		{
			...
			// cs.g:1175:13: ( '#' ( TS )* 'define' ( TS )+ define= IDENTIFIER )
			DebugEnterAlt(1);
			// cs.g:1176:2: '#' ( TS )* 'define' ( TS )+ define= IDENTIFIER
			{
	...
	private void mUNDEF_TOKEN()
	{
		...
		try
		{
			...
			// cs.g:1181:12: ( '#' ( TS )* 'undef' ( TS )+ define= IDENTIFIER )
			DebugEnterAlt(1);
			// cs.g:1182:2: '#' ( TS )* 'undef' ( TS )+ define= IDENTIFIER
			{
	...
	private void mELSE_TOKEN()
	{
		...
		try
		{
			...
			// cs.g:1188:11: ( ( '#' ( TS )* e= 'else' | '#' ( TS )* 'elif' ( TS )+ PP_EXPRESSION ) )
			DebugEnterAlt(1);
			// cs.g:1189:2: ( '#' ( TS )* e= 'else' | '#' ( TS )* 'elif' ( TS )+ PP_EXPRESSION )
			{
			...
			case 2:
				DebugEnterAlt(2);
				// cs.g:1190:4: '#' ( TS )* 'elif' ( TS )+ PP_EXPRESSION
				{
	...
	private void mPP_EXPRESSION()
	{
		...
		try
		{
			// cs.g:1242:14: ( PP_OR_EXPRESSION )
			DebugEnterAlt(1);
			// cs.g:1243:2: PP_OR_EXPRESSION
			{
			DebugLocation(1243, 2);
			mPP_OR_EXPRESSION(); 
	...
	private void mPP_OR_EXPRESSION()
	{
		...
		try
		{
			// cs.g:1245:17: ( PP_AND_EXPRESSION ( TS )* ( '||' ( TS )* PP_AND_EXPRESSION ( TS )* )* )
			DebugEnterAlt(1);
			// cs.g:1246:2: PP_AND_EXPRESSION ( TS )* ( '||' ( TS )* PP_AND_EXPRESSION ( TS )* )*
			{
			...
			// cs.g:1246:28: ( '||' ( TS )* PP_AND_EXPRESSION ( TS )* )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// cs.g:1246:29: '||' ( TS )* PP_AND_EXPRESSION ( TS )*
					{
					DebugLocation(1246, 29);
					Match("||"); 

					DebugLocation(1246, 36);
					// cs.g:1246:36: ( TS )*
					...
					DebugLocation(1246, 42);
					mPP_AND_EXPRESSION(); 
					DebugLocation(1246, 62);
					// cs.g:1246:62: ( TS )*
	...
	private void mPP_AND_EXPRESSION()
	{
		...
		try
		{
			// cs.g:1248:18: ( PP_EQUALITY_EXPRESSION ( TS )* ( '&&' ( TS )* PP_EQUALITY_EXPRESSION ( TS )* )* )
			DebugEnterAlt(1);
			// cs.g:1249:2: PP_EQUALITY_EXPRESSION ( TS )* ( '&&' ( TS )* PP_EQUALITY_EXPRESSION ( TS )* )*
			{
			DebugLocation(1249, 2);
			mPP_EQUALITY_EXPRESSION(); 
			DebugLocation(1249, 27);
			// cs.g:1249:27: ( TS )*
			...
			// cs.g:1249:33: ( '&&' ( TS )* PP_EQUALITY_EXPRESSION ( TS )* )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// cs.g:1249:34: '&&' ( TS )* PP_EQUALITY_EXPRESSION ( TS )*
					{
					DebugLocation(1249, 34);
					Match("&&"); 
	...
	private void mPP_EQUALITY_EXPRESSION()
	{
		...
		try
		{
			...
			// cs.g:1251:23: ( PP_UNARY_EXPRESSION ( TS )* ( ( '==' |ne= '!=' ) ( TS )* PP_UNARY_EXPRESSION ( TS )* )* )
			DebugEnterAlt(1);
			// cs.g:1252:2: PP_UNARY_EXPRESSION ( TS )* ( ( '==' |ne= '!=' ) ( TS )* PP_UNARY_EXPRESSION ( TS )* )*
			{
			DebugLocation(1252, 2);
			mPP_UNARY_EXPRESSION(); 
			DebugLocation(1252, 24);
			// cs.g:1252:24: ( TS )*
			...
			DebugLocation(1252, 30);
			// cs.g:1252:30: ( ( '==' |ne= '!=' ) ( TS )* PP_UNARY_EXPRESSION ( TS )* )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// cs.g:1252:31: ( '==' |ne= '!=' ) ( TS )* PP_UNARY_EXPRESSION ( TS )*
					{
					DebugLocation(1252, 31);
					// cs.g:1252:31: ( '==' |ne= '!=' )
					int alt47=2;
	...
	private void mPP_UNARY_EXPRESSION()
	{
		...
		try
		{
			...
			// cs.g:1260:20: (pe= PP_PRIMARY_EXPRESSION | '!' ( TS )* ue= PP_UNARY_EXPRESSION )
			int alt52=2;
			...
			case 1:
				DebugEnterAlt(1);
				// cs.g:1261:2: pe= PP_PRIMARY_EXPRESSION
				{
			...
			case 2:
				DebugEnterAlt(2);
				// cs.g:1262:4: '!' ( TS )* ue= PP_UNARY_EXPRESSION
				{
	...
	private void mPP_PRIMARY_EXPRESSION()
	{
		...
		try
		{
			...
			// cs.g:1265:22: ( IDENTIFIER | '(' PP_EXPRESSION ')' )
			int alt53=2;
			...
			case 1:
				DebugEnterAlt(1);
				// cs.g:1266:2: IDENTIFIER
				{
				DebugLocation(1266, 2);
			...
			case 2:
				DebugEnterAlt(2);
				// cs.g:1270:4: '(' PP_EXPRESSION ')'
				{
				DebugLocation(1270, 4);
				Match('('); 
				DebugLocation(1270, 10);
				mPP_EXPRESSION(); 
				DebugLocation(1270, 26);
				Match(')'); 
	...
	private void mIdentifierPart()
	{
		...
		try
		{
			// cs.g:1280:3: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' )
			DebugEnterAlt(1);
			// cs.g:
			{
			DebugLocation(1280, 3);
	...
	private void mEscapeSequence()
	{
		...
		try
		{
			// cs.g:1283:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'v' | 'a' | '\\\"' | '\\'' | '\\\\' | ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) | 'x' HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT ) )
			DebugEnterAlt(1);
			// cs.g:1283:9: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'v' | 'a' | '\\\"' | '\\'' | '\\\\' | ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) | 'x' HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
			{
			DebugLocation(1283, 9);
			Match('\\'); 
			DebugLocation(1283, 14);
			// cs.g:1283:14: ( 'b' | 't' | 'n' | 'f' | 'r' | 'v' | 'a' | '\\\"' | '\\'' | '\\\\' | ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) | 'x' HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
			int alt54=19;
			...
			case 11:
				DebugEnterAlt(11);
				// cs.g:1294:18: ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' )
				{
				DebugLocation(1294, 18);
				input.Consume();

				DebugLocation(1294, 29);
				input.Consume();
			...
			case 15:
				DebugEnterAlt(15);
				// cs.g:1298:18: 'x' HEX_DIGIT HEX_DIGIT
				{
			...
			case 16:
				DebugEnterAlt(16);
				// cs.g:1299:18: 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
			...
			case 17:
				DebugEnterAlt(17);
				// cs.g:1300:18: 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
			...
			case 18:
				DebugEnterAlt(18);
				// cs.g:1301:18: 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
				DebugLocation(1301, 18);
				Match('u'); 
				DebugLocation(1301, 24);
				mHEX_DIGIT(); 
				DebugLocation(1301, 36);
				mHEX_DIGIT(); 
				DebugLocation(1301, 47);
				mHEX_DIGIT(); 
			...
			case 19:
				DebugEnterAlt(19);
				// cs.g:1302:18: 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
				...
				mHEX_DIGIT(); 
				DebugLocation(1302, 47);
				mHEX_DIGIT(); 
				DebugLocation(1302, 58);
				mHEX_DIGIT(); 
				DebugLocation(1302, 69);
				mHEX_DIGIT(); 
				DebugLocation(1302, 80);
				mHEX_DIGIT(); 
				DebugLocation(1302, 91);
				mHEX_DIGIT(); 
	...
	private void mDecimal_integer_literal()
	{
		...
		try
		{
			// cs.g:1305:24: ( Decimal_digits ( INTEGER_TYPE_SUFFIX )? )
			DebugEnterAlt(1);
			// cs.g:1306:2: Decimal_digits ( INTEGER_TYPE_SUFFIX )?
			{
			DebugLocation(1306, 2);
			mDecimal_digits(); 
			DebugLocation(1306, 19);
			// cs.g:1306:19: ( INTEGER_TYPE_SUFFIX )?
			int alt55=2;
	...
	private void mHex_number()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// cs.g:1307:11: ( '0' ( 'x' | 'X' ) HEX_DIGITS ( INTEGER_TYPE_SUFFIX )? )
			DebugEnterAlt(1);
			// cs.g:1308:2: '0' ( 'x' | 'X' ) HEX_DIGITS ( INTEGER_TYPE_SUFFIX )?
			{
			DebugLocation(1308, 2);
			Match('0'); 
			DebugLocation(1308, 5);
			...
			DebugLocation(1308, 17);
			mHEX_DIGITS(); 
			DebugLocation(1308, 30);
			// cs.g:1308:30: ( INTEGER_TYPE_SUFFIX )?
			int alt56=2;
	...
	private void mDecimal_digits()
	{
		...
		try
		{
			// cs.g:1311:15: ( ( DECIMAL_DIGIT )+ )
			DebugEnterAlt(1);
			// cs.g:1312:2: ( DECIMAL_DIGIT )+
			{
	...
	private void mINTEGER_TYPE_SUFFIX()
	{
		...
		try
		{
			// cs.g:1317:20: ( 'U' | 'u' | 'L' | 'l' | 'UL' | 'Ul' | 'uL' | 'ul' | 'LU' | 'Lu' | 'lU' | 'lu' )
			int alt58=12;
	...
	private void mHEX_DIGITS()
	{
		...
		try
		{
			// cs.g:1318:20: ( ( HEX_DIGIT )+ )
			DebugEnterAlt(1);
			// cs.g:1319:2: ( HEX_DIGIT )+
			{
	...
	private void mExponent_part()
	{
		...
		try
		{
			// cs.g:1324:14: ( ( 'e' | 'E' ) ( Sign )? Decimal_digits )
			DebugEnterAlt(1);
			// cs.g:1325:2: ( 'e' | 'E' ) ( Sign )? Decimal_digits
			{
	...
	private class DFA16 : DFA
	{
		...
		public override string Description { get { return "1132:1: Real_literal : ( Decimal_digits '.' Decimal_digits ( Exponent_part )? ( Real_type_suffix )? | '.' Decimal_digits ( Exponent_part )? ( Real_type_suffix )? | Decimal_digits Exponent_part ( Real_type_suffix )? | Decimal_digits Real_type_suffix );"; } }
	...
	private class DFA23 : DFA
	{
		...
		public override string Description { get { return "1157:2: ( IF_TOKEN | DEFINE_TOKEN | ELSE_TOKEN | ENDIF_TOKEN | UNDEF_TOKEN )"; } }
	...
	private class DFA37 : DFA
	{
		...
		public override string Description { get { return "1189:2: ( '#' ( TS )* e= 'else' | '#' ( TS )* 'elif' ( TS )+ PP_EXPRESSION )"; } }
