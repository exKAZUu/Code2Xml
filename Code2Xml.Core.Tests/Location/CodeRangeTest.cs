...
namespace Code2Xml.Core.Tests.Location {
    ...
    public class CodeRangeTest {
        ...
        [TestCase(1, 0, 2, 5, ExpectedResult = false)]
        [TestCase(1, 0, 2, 10, ExpectedResult = false)]
        [TestCase(1, 0, 3, 10, ExpectedResult = false)]
        [TestCase(2, 0, 2, 1, ExpectedResult = false)]
        [TestCase(2, 0, 2, 5, ExpectedResult = false)]
        [TestCase(2, 0, 2, 10, ExpectedResult = false)]
        [TestCase(2, 0, 3, 10, ExpectedResult = false)]
        [TestCase(2, 5, 2, 10, ExpectedResult = true)]
        [TestCase(2, 5, 3, 1, ExpectedResult = true)]
        [TestCase(2, 5, 3, 3, ExpectedResult = true)]
        [TestCase(2, 5, 3, 10, ExpectedResult = false)]
        [TestCase(3, 7, 3, 8, ExpectedResult = false)]
        ...
        [TestCase(1, 0, 2, 1, ExpectedResult = false)]
        [TestCase(1, 0, 2, 5, ExpectedResult = false)]
        [TestCase(1, 0, 2, 6, ExpectedResult = true)]
        [TestCase(1, 0, 2, 10, ExpectedResult = true)]
        [TestCase(1, 0, 3, 10, ExpectedResult = true)]
        [TestCase(2, 0, 2, 1, ExpectedResult = false)]
        [TestCase(2, 0, 2, 5, ExpectedResult = false)]
        [TestCase(2, 0, 2, 6, ExpectedResult = true)]
        [TestCase(2, 0, 2, 10, ExpectedResult = true)]
        [TestCase(2, 0, 3, 10, ExpectedResult = true)]
        [TestCase(2, 5, 2, 10, ExpectedResult = true)]
        [TestCase(2, 5, 3, 1, ExpectedResult = true)]
        [TestCase(2, 5, 3, 3, ExpectedResult = true)]
        [TestCase(2, 5, 3, 10, ExpectedResult = true)]
        [TestCase(3, 2, 3, 8, ExpectedResult = true)]
        [TestCase(3, 3, 3, 8, ExpectedResult = false)]
        [TestCase(3, 7, 3, 8, ExpectedResult = false)]
