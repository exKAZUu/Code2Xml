...
pass")]
        ...
        [TestCase(@"https://github.com/reddit/reddit",
                @"f701b678799905506bc5ade9149ade336824259c", 7512)] // 1
        ...
        [TestCase(@"https://github.com/scrapy/scrapy",
                @"38dcf50cd6a6328f5ec293015dbe53733343991a", 6152)] // 3
        ...
        [TestCase(@"https://github.com/rg3/youtube-dl",
                @"b2e6a1c14c142eab299266641a72101f7d679443", 5668)] // 2
        ...
        public void ParseGitRepository(string url, string commitPointer, int starCount) {
            ...
            MeasurePerformance(url, commitPointer, null, "*.py");
        }
