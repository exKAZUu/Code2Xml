...
// $ANTLR 3.5.0.2 cs.g 2014-10-29 10:06:00
...
public partial class csLexer : Antlr.Runtime.Lexer
{
	...
	private void mT__124()
	{
		...
		try
		{
			int _type = T__124;
			int _channel = DefaultTokenChannel;
			// cs.g:71:8: ( 'descending' )
			DebugEnterAlt(1);
			// cs.g:71:10: 'descending'
			{
			DebugLocation(71, 10);
	...
	private void mT__154()
	{
		...
		try
		{
			int _type = T__154;
			int _channel = DefaultTokenChannel;
			// cs.g:101:8: ( 'namespace' )
			DebugEnterAlt(1);
			// cs.g:101:10: 'namespace'
			{
	...
	private void mT__168()
	{
		...
		try
		{
			int _type = T__168;
			int _channel = DefaultTokenChannel;
			// cs.g:115:8: ( 'protected' )
			DebugEnterAlt(1);
			// cs.g:115:10: 'protected'
			{
	...
	private void mT__179()
	{
		...
		try
		{
			int _type = T__179;
			int _channel = DefaultTokenChannel;
			// cs.g:126:8: ( 'stackalloc' )
			DebugEnterAlt(1);
			// cs.g:126:10: 'stackalloc'
			{
	...
	private void mT__191()
	{
		...
		try
		{
			int _type = T__191;
			int _channel = DefaultTokenChannel;
			// cs.g:138:8: ( 'unchecked' )
			DebugEnterAlt(1);
			// cs.g:138:10: 'unchecked'
			{
	...
	private void mCOMMENT()
	{
		...
		try
		{
			int _type = COMMENT;
			int _channel = DefaultTokenChannel;
			// cs.g:1106:8: ( '/*' ( options {greedy=false; } : . )* '*/' )
			DebugEnterAlt(1);
			// cs.g:1107:4: '/*' ( options {greedy=false; } : . )* '*/'
			{
			DebugLocation(1107, 4);
			Match("/*"); if (state.failed) return;

			DebugLocation(1108, 4);
			// cs.g:1108:4: ( options {greedy=false; } : . )*
	...
	private void mSTRINGLITERAL()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// cs.g:1112:5: ( '\"' ( EscapeSequence |~ ( '\"' | '\\\\' ) )* '\"' )
			DebugEnterAlt(1);
			// cs.g:1113:5: '\"' ( EscapeSequence |~ ( '\"' | '\\\\' ) )* '\"'
			{
			DebugLocation(1113, 5);
			Match('\"'); if (state.failed) return;
			DebugLocation(1113, 9);
			// cs.g:1113:9: ( EscapeSequence |~ ( '\"' | '\\\\' ) )*
	...
	private void mVerbatim_string_literal()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// cs.g:1114:24: ( '@' '\"' ( Verbatim_string_literal_character )* '\"' )
			DebugEnterAlt(1);
			// cs.g:1115:5: '@' '\"' ( Verbatim_string_literal_character )* '\"'
			{
			...
			// cs.g:1115:15: ( Verbatim_string_literal_character )*
	...
	private void mNUMBER()
	{
		...
		try
		{
			int _type = NUMBER;
			int _channel = DefaultTokenChannel;
			// cs.g:1119:7: ( Decimal_digits ( INTEGER_TYPE_SUFFIX )? )
			DebugEnterAlt(1);
			// cs.g:1120:5: Decimal_digits ( INTEGER_TYPE_SUFFIX )?
			{
			DebugLocation(1120, 5);
			mDecimal_digits(); if (state.failed) return;
			DebugLocation(1120, 20);
			// cs.g:1120:20: ( INTEGER_TYPE_SUFFIX )?
			int alt11=2;
	...
	private void mGooBall()
	{
		...
		try
		{
			...
			// cs.g:1133:2: (dil= Decimal_integer_literal d= Dot s= GooBallIdentifier )
			DebugEnterAlt(1);
			// cs.g:1134:2: dil= Decimal_integer_literal d= Dot s= GooBallIdentifier
			{
	...
	private void mGooBallIdentifier()
	{
		...
		try
		{
			// cs.g:1138:5: ( IdentifierStart ( IdentifierPart )* )
			DebugEnterAlt(1);
			// cs.g:1138:7: IdentifierStart ( IdentifierPart )*
			{
			DebugLocation(1138, 7);
			mIdentifierStart(); if (state.failed) return;
			DebugLocation(1138, 23);
			// cs.g:1138:23: ( IdentifierPart )*
	...
	private void mReal_literal()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// cs.g:1141:13: ( Decimal_digits '.' Decimal_digits ( Exponent_part )? ( Real_type_suffix )? | '.' Decimal_digits ( Exponent_part )? ( Real_type_suffix )? | Decimal_digits Exponent_part ( Real_type_suffix )? | Decimal_digits Real_type_suffix )
			int alt18=4;
			...
			case 1:
				DebugEnterAlt(1);
				// cs.g:1142:5: Decimal_digits '.' Decimal_digits ( Exponent_part )? ( Real_type_suffix )?
				{
			...
			case 2:
				DebugEnterAlt(2);
				// cs.g:1143:7: '.' Decimal_digits ( Exponent_part )? ( Real_type_suffix )?
				{
			...
			case 3:
				DebugEnterAlt(3);
				// cs.g:1144:7: Decimal_digits Exponent_part ( Real_type_suffix )?
				{
			...
			case 4:
				DebugEnterAlt(4);
				// cs.g:1145:7: Decimal_digits Real_type_suffix
				{
	...
	private void mCharacter_literal()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// cs.g:1146:18: ( '\\'' ( EscapeSequence |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ) '\\'' )
			DebugEnterAlt(1);
			// cs.g:1147:5: '\\'' ( EscapeSequence |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ) '\\''
			{
			DebugLocation(1147, 5);
			Match('\''); if (state.failed) return;
			DebugLocation(1148, 5);
			// cs.g:1148:5: ( EscapeSequence |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) |~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) ~ ( '\\\\' | '\\'' | '\\r' | '\\n' ) )
			int alt19=4;
	...
	private void mIDENTIFIER()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// cs.g:1155:11: ( IdentifierStart ( IdentifierPart )* )
			DebugEnterAlt(1);
			// cs.g:1156:5: IdentifierStart ( IdentifierPart )*
			{
			DebugLocation(1156, 5);
			mIdentifierStart(); if (state.failed) return;
			DebugLocation(1156, 21);
			// cs.g:1156:21: ( IdentifierPart )*
	...
	private void mPRAGMA()
	{
		...
		try
		{
			int _type = PRAGMA;
			int _channel = DefaultTokenChannel;
			// cs.g:1157:7: ( '#' ( TS )* ( 'pragma' | 'region' | 'endregion' | 'line' | 'warning' | 'error' ) (~ ( '\\r' | '\\n' ) )* ( ( '\\r' | '\\n' )+ | EOF ) )
			DebugEnterAlt(1);
			// cs.g:1159:5: '#' ( TS )* ( 'pragma' | 'region' | 'endregion' | 'line' | 'warning' | 'error' ) (~ ( '\\r' | '\\n' ) )* ( ( '\\r' | '\\n' )+ | EOF )
			{
			...
			// cs.g:1159:13: ( 'pragma' | 'region' | 'endregion' | 'line' | 'warning' | 'error' )
			int alt22=6;
	...
	private void mPREPROCESSOR_DIRECTIVE()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// cs.g:1161:23: ( PP_CONDITIONAL )
			DebugEnterAlt(1);
			// cs.g:1162:5: PP_CONDITIONAL
			{
	...
	private void mPP_CONDITIONAL()
	{
		...
		try
		{
			// cs.g:1166:15: ( ( IF_TOKEN | ELSE_TOKEN | ENDIF_TOKEN | DEFINE_TOKEN | UNDEF_TOKEN ) ( TS )* ( LINE_COMMENT | ( '\\r' | '\\n' )+ | EOF ) )
			DebugEnterAlt(1);
			// cs.g:1167:5: ( IF_TOKEN | ELSE_TOKEN | ENDIF_TOKEN | DEFINE_TOKEN | UNDEF_TOKEN ) ( TS )* ( LINE_COMMENT | ( '\\r' | '\\n' )+ | EOF )
			{
			DebugLocation(1167, 5);
			// cs.g:1167:5: ( IF_TOKEN | ELSE_TOKEN | ENDIF_TOKEN | DEFINE_TOKEN | UNDEF_TOKEN )
			int alt26=5;
	...
	private void mIF_TOKEN()
	{
		...
		try
		{
			// cs.g:1173:9: ( ( '#' ( TS )* 'if' ( ( TS )+ PP_EXPRESSION | ( '(' )=> PP_PRIMARY_EXPRESSION | ( '!' )=> PP_UNARY_EXPRESSION ) ) )
			DebugEnterAlt(1);
			// cs.g:1174:5: ( '#' ( TS )* 'if' ( ( TS )+ PP_EXPRESSION | ( '(' )=> PP_PRIMARY_EXPRESSION | ( '!' )=> PP_UNARY_EXPRESSION ) )
			{
			DebugLocation(1174, 5);
			// cs.g:1174:5: ( '#' ( TS )* 'if' ( ( TS )+ PP_EXPRESSION | ( '(' )=> PP_PRIMARY_EXPRESSION | ( '!' )=> PP_UNARY_EXPRESSION ) )
			DebugEnterAlt(1);
			// cs.g:1174:6: '#' ( TS )* 'if' ( ( TS )+ PP_EXPRESSION | ( '(' )=> PP_PRIMARY_EXPRESSION | ( '!' )=> PP_UNARY_EXPRESSION )
			{
			...
			// cs.g:1174:24: ( ( TS )+ PP_EXPRESSION | ( '(' )=> PP_PRIMARY_EXPRESSION | ( '!' )=> PP_UNARY_EXPRESSION )
			int alt32=3;
			...
			case 2:
				DebugEnterAlt(2);
				// cs.g:1175:23: ( '(' )=> PP_PRIMARY_EXPRESSION
				{
			...
			case 3:
				DebugEnterAlt(3);
				// cs.g:1176:11: ( '!' )=> PP_UNARY_EXPRESSION
				{
	...
	private void mDEFINE_TOKEN()
	{
		...
		try
		{
			...
			// cs.g:1189:13: ( '#' ( TS )* 'define' ( TS )+ define= IDENTIFIER )
			DebugEnterAlt(1);
			// cs.g:1190:5: '#' ( TS )* 'define' ( TS )+ define= IDENTIFIER
			{
	...
	private void mUNDEF_TOKEN()
	{
		...
		try
		{
			...
			// cs.g:1195:12: ( '#' ( TS )* 'undef' ( TS )+ define= IDENTIFIER )
			DebugEnterAlt(1);
			// cs.g:1196:5: '#' ( TS )* 'undef' ( TS )+ define= IDENTIFIER
			{
	...
	private void mELSE_TOKEN()
	{
		...
		try
		{
			...
			// cs.g:1202:11: ( ( '#' ( TS )* e= 'else' | '#' ( TS )* 'elif' ( ( TS )+ PP_EXPRESSION | '(' ( TS )* PP_EXPRESSION ( TS )* ')' ) ) )
			DebugEnterAlt(1);
			// cs.g:1203:5: ( '#' ( TS )* e= 'else' | '#' ( TS )* 'elif' ( ( TS )+ PP_EXPRESSION | '(' ( TS )* PP_EXPRESSION ( TS )* ')' ) )
			{
			...
			case 2:
				DebugEnterAlt(2);
				// cs.g:1204:7: '#' ( TS )* 'elif' ( ( TS )+ PP_EXPRESSION | '(' ( TS )* PP_EXPRESSION ( TS )* ')' )
				{
				...
				// cs.g:1204:28: ( ( TS )+ PP_EXPRESSION | '(' ( TS )* PP_EXPRESSION ( TS )* ')' )
				int alt42=2;
				...
				case 2:
					DebugEnterAlt(2);
					// cs.g:1204:49: '(' ( TS )* PP_EXPRESSION ( TS )* ')'
					{
	...
	private void mENDIF_TOKEN()
	{
		...
		try
		{
			// cs.g:1237:12: ( '#' ( TS )* 'endif' )
			DebugEnterAlt(1);
			// cs.g:1238:5: '#' ( TS )* 'endif'
			{
	...
	private void mPP_EXPRESSION()
	{
		...
		try
		{
			// cs.g:1246:14: ( PP_OR_EXPRESSION )
			DebugEnterAlt(1);
			// cs.g:1247:5: PP_OR_EXPRESSION
			{
	...
	private void mPP_OR_EXPRESSION()
	{
		...
		try
		{
			// cs.g:1249:17: ( PP_AND_EXPRESSION ( TS )* ( '||' ( TS )* PP_AND_EXPRESSION ( TS )* )* )
			DebugEnterAlt(1);
			// cs.g:1250:5: PP_AND_EXPRESSION ( TS )* ( '||' ( TS )* PP_AND_EXPRESSION ( TS )* )*
			{
			...
			// cs.g:1250:37: ( '||' ( TS )* PP_AND_EXPRESSION ( TS )* )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// cs.g:1250:38: '||' ( TS )* PP_AND_EXPRESSION ( TS )*
					{
	...
	private void mPP_AND_EXPRESSION()
	{
		...
		try
		{
			// cs.g:1258:18: ( PP_EQUALITY_EXPRESSION ( TS )* ( '&&' ( TS )* PP_EQUALITY_EXPRESSION ( TS )* )* )
			DebugEnterAlt(1);
			// cs.g:1259:5: PP_EQUALITY_EXPRESSION ( TS )* ( '&&' ( TS )* PP_EQUALITY_EXPRESSION ( TS )* )*
			{
			...
			// cs.g:1259:37: ( '&&' ( TS )* PP_EQUALITY_EXPRESSION ( TS )* )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// cs.g:1259:38: '&&' ( TS )* PP_EQUALITY_EXPRESSION ( TS )*
					{
	...
	private void mPP_EQUALITY_EXPRESSION()
	{
		...
		try
		{
			...
			// cs.g:1267:23: ( PP_UNARY_EXPRESSION ( TS )* ( ( '==' |ne= '!=' ) ( TS )* PP_UNARY_EXPRESSION ( TS )* )* )
			DebugEnterAlt(1);
			// cs.g:1268:5: PP_UNARY_EXPRESSION ( TS )* ( ( '==' |ne= '!=' ) ( TS )* PP_UNARY_EXPRESSION ( TS )* )*
			{
			...
			// cs.g:1268:37: ( ( '==' |ne= '!=' ) ( TS )* PP_UNARY_EXPRESSION ( TS )* )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// cs.g:1268:38: ( '==' |ne= '!=' ) ( TS )* PP_UNARY_EXPRESSION ( TS )*
					{
	...
	private void mPP_UNARY_EXPRESSION()
	{
		...
		try
		{
			// cs.g:1277:20: ( '!' ( TS )* PP_UNARY_EXPRESSION | PP_PRIMARY_EXPRESSION )
			int alt59=2;
			...
			case 1:
				DebugEnterAlt(1);
				// cs.g:1278:5: '!' ( TS )* PP_UNARY_EXPRESSION
				{
			...
			case 2:
				DebugEnterAlt(2);
				// cs.g:1282:4: PP_PRIMARY_EXPRESSION
				{
	...
	private void mPP_PRIMARY_EXPRESSION()
	{
		...
		try
		{
			...
			// cs.g:1285:22: ( '(' ( TS )* PP_EXPRESSION ( TS )* ')' | IDENTIFIER )
			int alt62=2;
			...
			case 1:
				DebugEnterAlt(1);
				// cs.g:1286:4: '(' ( TS )* PP_EXPRESSION ( TS )* ')'
				{
	...
	private void mIdentifierStart()
	{
		...
		try
		{
			// cs.g:1297:5: ( '@' | '_' | 'A' .. 'Z' | 'a' .. 'z' | UnicodeEscapeSequence )
			int alt63=5;
			...
			case 5:
				DebugEnterAlt(5);
				// cs.g:1297:43: UnicodeEscapeSequence
				{
	...
	private void mIdentifierPart()
	{
		...
		try
		{
			// cs.g:1300:3: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | UnicodeEscapeSequence )
			int alt64=5;
			...
			case 5:
				DebugEnterAlt(5);
				// cs.g:1300:42: UnicodeEscapeSequence
				{
	...
	private void mEscapeSequence()
	{
		...
		try
		{
			// cs.g:1303:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'v' | 'a' | '\\\"' | '\\'' | '\\\\' | ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) | 'x' HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT ) )
			DebugEnterAlt(1);
			// cs.g:1303:9: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'v' | 'a' | '\\\"' | '\\'' | '\\\\' | ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) | 'x' HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
			{
			DebugLocation(1303, 9);
			Match('\\'); if (state.failed) return;
			DebugLocation(1303, 14);
			// cs.g:1303:14: ( 'b' | 't' | 'n' | 'f' | 'r' | 'v' | 'a' | '\\\"' | '\\'' | '\\\\' | ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) | 'x' HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
			int alt65=19;
			...
			case 15:
				DebugEnterAlt(15);
				// cs.g:1318:18: 'x' HEX_DIGIT HEX_DIGIT
				{
			...
			case 16:
				DebugEnterAlt(16);
				// cs.g:1319:18: 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
			...
			case 17:
				DebugEnterAlt(17);
				// cs.g:1320:18: 'x' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
			...
			case 18:
				DebugEnterAlt(18);
				// cs.g:1321:18: 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
			...
			case 19:
				DebugEnterAlt(19);
				// cs.g:1322:18: 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
	...
	private void mUnicodeEscapeSequence()
	{
		...
		try
		{
			// cs.g:1327:5: ( '\\\\' ( 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT ) )
			DebugEnterAlt(1);
			// cs.g:1327:9: '\\\\' ( 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
			{
			DebugLocation(1327, 9);
			Match('\\'); if (state.failed) return;
			DebugLocation(1327, 14);
			// cs.g:1327:14: ( 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
			int alt66=2;
			...
			case 1:
				DebugEnterAlt(1);
				// cs.g:1328:18: 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
			...
			case 2:
				DebugEnterAlt(2);
				// cs.g:1329:18: 'U' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
				{
	...
	private void mDecimal_integer_literal()
	{
		...
		try
		{
			// cs.g:1333:24: ( Decimal_digits ( INTEGER_TYPE_SUFFIX )? )
			DebugEnterAlt(1);
			// cs.g:1334:5: Decimal_digits ( INTEGER_TYPE_SUFFIX )?
			{
			DebugLocation(1334, 5);
			mDecimal_digits(); if (state.failed) return;
			DebugLocation(1334, 22);
			// cs.g:1334:22: ( INTEGER_TYPE_SUFFIX )?
			int alt67=2;
	...
	private void mHex_number()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// cs.g:1338:11: ( '0' ( 'x' | 'X' ) HEX_DIGITS ( INTEGER_TYPE_SUFFIX )? )
			DebugEnterAlt(1);
			// cs.g:1339:5: '0' ( 'x' | 'X' ) HEX_DIGITS ( INTEGER_TYPE_SUFFIX )?
			{
			...
			// cs.g:1339:33: ( INTEGER_TYPE_SUFFIX )?
			int alt68=2;
	...
	private void mDecimal_digits()
	{
		...
		try
		{
			// cs.g:1342:15: ( ( DECIMAL_DIGIT )+ )
			DebugEnterAlt(1);
			// cs.g:1343:5: ( DECIMAL_DIGIT )+
			{
	...
	private void mINTEGER_TYPE_SUFFIX()
	{
		...
		try
		{
			// cs.g:1348:20: ( 'U' | 'u' | 'L' | 'l' | 'UL' | 'Ul' | 'uL' | 'ul' | 'LU' | 'Lu' | 'lU' | 'lu' )
			int alt70=12;
	...
	private void mHEX_DIGITS()
	{
		...
		try
		{
			// cs.g:1349:20: ( ( HEX_DIGIT )+ )
			DebugEnterAlt(1);
			// cs.g:1350:5: ( HEX_DIGIT )+
			{
	...
	private void mExponent_part()
	{
		...
		try
		{
			// cs.g:1355:14: ( ( 'e' | 'E' ) ( Sign )? Decimal_digits )
			DebugEnterAlt(1);
			// cs.g:1356:5: ( 'e' | 'E' ) ( Sign )? Decimal_digits
			{
	...
	public override void mTokens()
	{
		...
		case 166:
			DebugEnterAlt(166);
			// cs.g:1:1114: Verbatim_string_literal
			{
		...
		case 173:
			DebugEnterAlt(173);
			// cs.g:1:1202: PREPROCESSOR_DIRECTIVE
			{
