...
// $ANTLR 3.5.0.2 Php.g 2014-10-29 10:26:10
...
public partial class PhpLexer : Antlr.Runtime.Lexer
{
	...
	private void mBodyString()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Php.g:527:2: ( '?>' BodyStringRest )
			DebugEnterAlt(1);
			// Php.g:527:4: '?>' BodyStringRest
			{
			DebugLocation(527, 4);
			Match("?>"); if (state.failed) return;
	...
	private void mBodyStringRest()
	{
		...
		try
		{
			// Php.g:533:2: ({...}? => BodyStringRestShortTag | ( ( '<' ~ '?' )=> '<' |~ '<' )* ( '<?' ( 'php' | '=' ) )? )
			int alt4=2;
			...
			case 1:
				DebugEnterAlt(1);
				// Php.g:533:4: {...}? => BodyStringRestShortTag
				{
				DebugLocation(533, 4);
				if (!((AllowShortOpenTag)))
				{
	...
	private void mIntType()
	{
		...
		try
		{
			int _type = IntType;
			int _channel = DefaultTokenChannel;
			// Php.g:556:2: ( ( 'i' | 'I' ) ( 'n' | 'N' ) ( 't' | 'T' ) )
			DebugEnterAlt(1);
			// Php.g:556:4: ( 'i' | 'I' ) ( 'n' | 'N' ) ( 't' | 'T' )
			{
			DebugLocation(556, 4);
	...
	private void mIntegerType()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Php.g:560:2: ( ( 'i' | 'I' ) ( 'n' | 'N' ) ( 't' | 'T' ) ( 'e' | 'E' ) ( 'g' | 'G' ) ( 'e' | 'E' ) ( 'r' | 'R' ) )
			DebugEnterAlt(1);
			// Php.g:560:4: ( 'i' | 'I' ) ( 'n' | 'N' ) ( 't' | 'T' ) ( 'e' | 'E' ) ( 'g' | 'G' ) ( 'e' | 'E' ) ( 'r' | 'R' )
			{
			DebugLocation(560, 4);
			if (input.LA(1)=='I'||input.LA(1)=='i')
			{
	...
	private void mBoolType()
	{
		...
		try
		{
			int _type = BoolType;
			int _channel = DefaultTokenChannel;
			// Php.g:564:2: ( ( 'b' | 'B' ) ( 'o' | 'O' ) ( 'o' | 'O' ) ( 'l' | 'L' ) )
			DebugEnterAlt(1);
			// Php.g:564:4: ( 'b' | 'B' ) ( 'o' | 'O' ) ( 'o' | 'O' ) ( 'l' | 'L' )
			{
			DebugLocation(564, 4);
	...
	private void mBooleanType()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Php.g:568:2: ( ( 'b' | 'B' ) ( 'o' | 'O' ) ( 'o' | 'O' ) ( 'l' | 'L' ) ( 'e' | 'E' ) ( 'a' | 'A' ) ( 'n' | 'N' ) )
			DebugEnterAlt(1);
			// Php.g:568:4: ( 'b' | 'B' ) ( 'o' | 'O' ) ( 'o' | 'O' ) ( 'l' | 'L' ) ( 'e' | 'E' ) ( 'a' | 'A' ) ( 'n' | 'N' )
			{
			DebugLocation(568, 4);
			if (input.LA(1)=='B'||input.LA(1)=='b')
			{
	...
	private void mFloatType()
	{
		...
		try
		{
			int _type = FloatType;
			int _channel = DefaultTokenChannel;
			// Php.g:572:2: ( ( 'f' | 'F' ) ( 'l' | 'L' ) ( 'o' | 'O' ) ( 'a' | 'A' ) ( 't' | 'T' ) )
			DebugEnterAlt(1);
			// Php.g:572:4: ( 'f' | 'F' ) ( 'l' | 'L' ) ( 'o' | 'O' ) ( 'a' | 'A' ) ( 't' | 'T' )
			{
			DebugLocation(572, 4);
	...
	private void mDoubleType()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Php.g:576:2: ( ( 'd' | 'D' ) ( 'o' | 'O' ) ( 'u' | 'U' ) ( 'b' | 'B' ) ( 'l' | 'L' ) ( 'e' | 'E' ) )
			DebugEnterAlt(1);
			// Php.g:576:4: ( 'd' | 'D' ) ( 'o' | 'O' ) ( 'u' | 'U' ) ( 'b' | 'B' ) ( 'l' | 'L' ) ( 'e' | 'E' )
			{
			DebugLocation(576, 4);
	...
	private void mRealType()
	{
		...
		try
		{
			int _type = RealType;
			int _channel = DefaultTokenChannel;
			// Php.g:580:2: ( ( 'r' | 'R' ) ( 'e' | 'E' ) ( 'a' | 'A' ) ( 'l' | 'L' ) )
			DebugEnterAlt(1);
			// Php.g:580:4: ( 'r' | 'R' ) ( 'e' | 'E' ) ( 'a' | 'A' ) ( 'l' | 'L' )
			{
			DebugLocation(580, 4);
			if (input.LA(1)=='R'||input.LA(1)=='r')
			{
	...
	private void mStringType()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Php.g:584:2: ( ( 's' | 'S' ) ( 't' | 'T' ) ( 'r' | 'R' ) ( 'i' | 'I' ) ( 'n' | 'N' ) ( 'g' | 'G' ) )
			DebugEnterAlt(1);
			// Php.g:584:4: ( 's' | 'S' ) ( 't' | 'T' ) ( 'r' | 'R' ) ( 'i' | 'I' ) ( 'n' | 'N' ) ( 'g' | 'G' )
			{
			DebugLocation(584, 4);
	...
	private void mObjectType()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Php.g:588:2: ( ( 'o' | 'O' ) ( 'b' | 'B' ) ( 'j' | 'J' ) ( 'e' | 'E' ) ( 'c' | 'C' ) ( 't' | 'T' ) )
			DebugEnterAlt(1);
			// Php.g:588:4: ( 'o' | 'O' ) ( 'b' | 'B' ) ( 'j' | 'J' ) ( 'e' | 'E' ) ( 'c' | 'C' ) ( 't' | 'T' )
			{
			DebugLocation(588, 4);
			if (input.LA(1)=='O'||input.LA(1)=='o')
			{
	...
	private void mUnsetType()
	{
		...
		try
		{
			int _type = UnsetType;
			int _channel = DefaultTokenChannel;
			// Php.g:592:2: ( ( 'u' | 'U' ) ( 'n' | 'N' ) ( 's' | 'S' ) ( 'e' | 'E' ) ( 't' | 'T' ) )
			DebugEnterAlt(1);
			// Php.g:592:4: ( 'u' | 'U' ) ( 'n' | 'N' ) ( 's' | 'S' ) ( 'e' | 'E' ) ( 't' | 'T' )
			{
			DebugLocation(592, 4);
			if (input.LA(1)=='U'||input.LA(1)=='u')
			{
	...
	private void mArrayType()
	{
		...
		try
		{
			int _type = ArrayType;
			int _channel = DefaultTokenChannel;
			// Php.g:596:2: ( ( 'a' | 'A' ) ( 'r' | 'R' ) ( 'r' | 'R' ) ( 'a' | 'A' ) ( 'y' | 'Y' ) )
			DebugEnterAlt(1);
			// Php.g:596:4: ( 'a' | 'A' ) ( 'r' | 'R' ) ( 'r' | 'R' ) ( 'a' | 'A' ) ( 'y' | 'Y' )
			{
			DebugLocation(596, 4);
			if (input.LA(1)=='A'||input.LA(1)=='a')
			{
	...
	private void mNew()
	{
		...
		try
		{
			int _type = New;
			int _channel = DefaultTokenChannel;
			// Php.g:599:5: ( ( 'n' | 'N' ) ( 'e' | 'E' ) ( 'w' | 'W' ) )
			DebugEnterAlt(1);
			// Php.g:599:7: ( 'n' | 'N' ) ( 'e' | 'E' ) ( 'w' | 'W' )
			{
			DebugLocation(599, 7);
			if (input.LA(1)=='N'||input.LA(1)=='n')
			{
	...
	private void mClone()
	{
		...
		try
		{
			int _type = Clone;
			int _channel = DefaultTokenChannel;
			// Php.g:600:7: ( ( 'c' | 'C' ) ( 'l' | 'L' ) ( 'o' | 'O' ) ( 'n' | 'N' ) ( 'e' | 'E' ) )
			DebugEnterAlt(1);
			// Php.g:600:9: ( 'c' | 'C' ) ( 'l' | 'L' ) ( 'o' | 'O' ) ( 'n' | 'N' ) ( 'e' | 'E' )
			{
			DebugLocation(600, 9);
			if (input.LA(1)=='C'||input.LA(1)=='c')
			{
	...
	private void mEcho()
	{
		...
		try
		{
			int _type = Echo;
			int _channel = DefaultTokenChannel;
			// Php.g:601:6: ( ( 'e' | 'E' ) ( 'c' | 'C' ) ( 'h' | 'H' ) ( 'o' | 'O' ) )
			DebugEnterAlt(1);
			// Php.g:601:8: ( 'e' | 'E' ) ( 'c' | 'C' ) ( 'h' | 'H' ) ( 'o' | 'O' )
			{
			DebugLocation(601, 8);
			if (input.LA(1)=='E'||input.LA(1)=='e')
			{
	...
	private void mPrint()
	{
		...
		try
		{
			int _type = Print;
			int _channel = DefaultTokenChannel;
			// Php.g:602:7: ( ( 'p' | 'P' ) ( 'r' | 'R' ) ( 'i' | 'I' ) ( 'n' | 'N' ) ( 't' | 'T' ) )
			DebugEnterAlt(1);
			// Php.g:602:9: ( 'p' | 'P' ) ( 'r' | 'R' ) ( 'i' | 'I' ) ( 'n' | 'N' ) ( 't' | 'T' )
			{
			DebugLocation(602, 9);
	...
	private void mElse()
	{
		...
		try
		{
			int _type = Else;
			int _channel = DefaultTokenChannel;
			// Php.g:604:6: ( ( 'e' | 'E' ) ( 'l' | 'L' ) ( 's' | 'S' ) ( 'e' | 'E' ) )
			DebugEnterAlt(1);
			// Php.g:604:8: ( 'e' | 'E' ) ( 'l' | 'L' ) ( 's' | 'S' ) ( 'e' | 'E' )
			{
			DebugLocation(604, 8);
			if (input.LA(1)=='E'||input.LA(1)=='e')
			{
	...
	private void mElseIf()
	{
		...
		try
		{
			int _type = ElseIf;
			int _channel = DefaultTokenChannel;
			// Php.g:605:8: ( ( 'e' | 'E' ) ( 'l' | 'L' ) ( 's' | 'S' ) ( 'e' | 'E' ) ( 'i' | 'I' ) ( 'f' | 'F' ) )
			DebugEnterAlt(1);
			// Php.g:605:10: ( 'e' | 'E' ) ( 'l' | 'L' ) ( 's' | 'S' ) ( 'e' | 'E' ) ( 'i' | 'I' ) ( 'f' | 'F' )
			{
	...
	private void mFor()
	{
		...
		try
		{
			int _type = For;
			int _channel = DefaultTokenChannel;
			// Php.g:606:5: ( ( 'f' | 'F' ) ( 'o' | 'O' ) ( 'r' | 'R' ) )
			DebugEnterAlt(1);
			// Php.g:606:7: ( 'f' | 'F' ) ( 'o' | 'O' ) ( 'r' | 'R' )
			{
			DebugLocation(606, 7);
			if (input.LA(1)=='F'||input.LA(1)=='f')
			{
	...
	private void mForeach()
	{
		...
		try
		{
			int _type = Foreach;
			int _channel = DefaultTokenChannel;
			// Php.g:607:9: ( ( 'f' | 'F' ) ( 'o' | 'O' ) ( 'r' | 'R' ) ( 'e' | 'E' ) ( 'a' | 'A' ) ( 'c' | 'C' ) ( 'h' | 'H' ) )
			DebugEnterAlt(1);
			// Php.g:607:11: ( 'f' | 'F' ) ( 'o' | 'O' ) ( 'r' | 'R' ) ( 'e' | 'E' ) ( 'a' | 'A' ) ( 'c' | 'C' ) ( 'h' | 'H' )
			{
	...
	private void mWhile()
	{
		...
		try
		{
			int _type = While;
			int _channel = DefaultTokenChannel;
			// Php.g:608:7: ( ( 'w' | 'W' ) ( 'h' | 'H' ) ( 'i' | 'I' ) ( 'l' | 'L' ) ( 'e' | 'E' ) )
			DebugEnterAlt(1);
			// Php.g:608:9: ( 'w' | 'W' ) ( 'h' | 'H' ) ( 'i' | 'I' ) ( 'l' | 'L' ) ( 'e' | 'E' )
			{
			DebugLocation(608, 9);
			if (input.LA(1)=='W'||input.LA(1)=='w')
			{
	...
	private void mTry()
	{
		...
		try
		{
			int _type = Try;
			int _channel = DefaultTokenChannel;
			// Php.g:610:5: ( ( 't' | 'T' ) ( 'r' | 'R' ) ( 'y' | 'Y' ) )
			DebugEnterAlt(1);
			// Php.g:610:7: ( 't' | 'T' ) ( 'r' | 'R' ) ( 'y' | 'Y' )
			{
			DebugLocation(610, 7);
			if (input.LA(1)=='T'||input.LA(1)=='t')
			{
	...
	private void mCatch()
	{
		...
		try
		{
			int _type = Catch;
			int _channel = DefaultTokenChannel;
			// Php.g:611:7: ( ( 'c' | 'C' ) ( 'a' | 'A' ) ( 't' | 'T' ) ( 'c' | 'C' ) ( 'h' | 'H' ) )
			DebugEnterAlt(1);
			// Php.g:611:9: ( 'c' | 'C' ) ( 'a' | 'A' ) ( 't' | 'T' ) ( 'c' | 'C' ) ( 'h' | 'H' )
			{
			DebugLocation(611, 9);
			if (input.LA(1)=='C'||input.LA(1)=='c')
			{
	...
	private void mFinally()
	{
		...
		try
		{
			int _type = Finally;
			int _channel = DefaultTokenChannel;
			// Php.g:612:9: ( ( 'f' | 'F' ) ( 'i' | 'I' ) ( 'n' | 'N' ) ( 'a' | 'A' ) ( 'l' | 'L' ) ( 'l' | 'L' ) ( 'y' | 'Y' ) )
			DebugEnterAlt(1);
			// Php.g:612:11: ( 'f' | 'F' ) ( 'i' | 'I' ) ( 'n' | 'N' ) ( 'a' | 'A' ) ( 'l' | 'L' ) ( 'l' | 'L' ) ( 'y' | 'Y' )
			{
	...
	private void mSwitch()
	{
		...
		try
		{
			int _type = Switch;
			int _channel = DefaultTokenChannel;
			// Php.g:613:8: ( ( 's' | 'S' ) ( 'w' | 'W' ) ( 'i' | 'I' ) ( 't' | 'T' ) ( 'c' | 'C' ) ( 'h' | 'H' ) )
			DebugEnterAlt(1);
			// Php.g:613:10: ( 's' | 'S' ) ( 'w' | 'W' ) ( 'i' | 'I' ) ( 't' | 'T' ) ( 'c' | 'C' ) ( 'h' | 'H' )
			{
	...
	private void mCase()
	{
		...
		try
		{
			int _type = Case;
			int _channel = DefaultTokenChannel;
			// Php.g:614:6: ( ( 'c' | 'C' ) ( 'a' | 'A' ) ( 's' | 'S' ) ( 'e' | 'E' ) )
			DebugEnterAlt(1);
			// Php.g:614:8: ( 'c' | 'C' ) ( 'a' | 'A' ) ( 's' | 'S' ) ( 'e' | 'E' )
			{
			DebugLocation(614, 8);
			if (input.LA(1)=='C'||input.LA(1)=='c')
			{
	...
	private void mDefault()
	{
		...
		try
		{
			int _type = Default;
			int _channel = DefaultTokenChannel;
			// Php.g:615:9: ( ( 'd' | 'D' ) ( 'e' | 'E' ) ( 'f' | 'F' ) ( 'a' | 'A' ) ( 'u' | 'U' ) ( 'l' | 'L' ) ( 't' | 'T' ) )
			DebugEnterAlt(1);
			// Php.g:615:11: ( 'd' | 'D' ) ( 'e' | 'E' ) ( 'f' | 'F' ) ( 'a' | 'A' ) ( 'u' | 'U' ) ( 'l' | 'L' ) ( 't' | 'T' )
			{
	...
	private void mNamespace()
	{
		...
		try
		{
			int _type = Namespace;
			int _channel = DefaultTokenChannel;
			// Php.g:616:11: ( ( 'n' | 'N' ) ( 'a' | 'A' ) ( 'm' | 'M' ) ( 'e' | 'E' ) ( 's' | 'S' ) ( 'p' | 'P' ) ( 'a' | 'A' ) ( 'c' | 'C' ) ( 'e' | 'E' ) )
			DebugEnterAlt(1);
			// Php.g:616:13: ( 'n' | 'N' ) ( 'a' | 'A' ) ( 'm' | 'M' ) ( 'e' | 'E' ) ( 's' | 'S' ) ( 'p' | 'P' ) ( 'a' | 'A' ) ( 'c' | 'C' ) ( 'e' | 'E' )
			{
	...
	private void mFunction()
	{
		...
		try
		{
			int _type = Function;
			int _channel = DefaultTokenChannel;
			// Php.g:617:10: ( ( 'f' | 'F' ) ( 'u' | 'U' ) ( 'n' | 'N' ) ( 'c' | 'C' ) ( 't' | 'T' ) ( 'i' | 'I' ) ( 'o' | 'O' ) ( 'n' | 'N' ) )
			DebugEnterAlt(1);
			// Php.g:617:12: ( 'f' | 'F' ) ( 'u' | 'U' ) ( 'n' | 'N' ) ( 'c' | 'C' ) ( 't' | 'T' ) ( 'i' | 'I' ) ( 'o' | 'O' ) ( 'n' | 'N' )
			{
	...
	private void mBreak()
	{
		...
		try
		{
			int _type = Break;
			int _channel = DefaultTokenChannel;
			// Php.g:618:7: ( ( 'b' | 'B' ) ( 'r' | 'R' ) ( 'e' | 'E' ) ( 'a' | 'A' ) ( 'k' | 'K' ) )
			DebugEnterAlt(1);
			// Php.g:618:9: ( 'b' | 'B' ) ( 'r' | 'R' ) ( 'e' | 'E' ) ( 'a' | 'A' ) ( 'k' | 'K' )
			{
			DebugLocation(618, 9);
			if (input.LA(1)=='B'||input.LA(1)=='b')
			{
	...
	private void mContinue()
	{
		...
		try
		{
			int _type = Continue;
			int _channel = DefaultTokenChannel;
			// Php.g:619:10: ( ( 'c' | 'C' ) ( 'o' | 'O' ) ( 'n' | 'N' ) ( 't' | 'T' ) ( 'i' | 'I' ) ( 'n' | 'N' ) ( 'u' | 'U' ) ( 'e' | 'E' ) )
			DebugEnterAlt(1);
			// Php.g:619:12: ( 'c' | 'C' ) ( 'o' | 'O' ) ( 'n' | 'N' ) ( 't' | 'T' ) ( 'i' | 'I' ) ( 'n' | 'N' ) ( 'u' | 'U' ) ( 'e' | 'E' )
			{
	...
	private void mGoto()
	{
		...
		try
		{
			int _type = Goto;
			int _channel = DefaultTokenChannel;
			// Php.g:620:6: ( ( 'g' | 'G' ) ( 'o' | 'O' ) ( 't' | 'T' ) ( 'o' | 'O' ) )
			DebugEnterAlt(1);
			// Php.g:620:8: ( 'g' | 'G' ) ( 'o' | 'O' ) ( 't' | 'T' ) ( 'o' | 'O' )
			{
			DebugLocation(620, 8);
			if (input.LA(1)=='G'||input.LA(1)=='g')
			{
	...
	private void mReturn()
	{
		...
		try
		{
			int _type = Return;
			int _channel = DefaultTokenChannel;
			// Php.g:621:8: ( ( 'r' | 'R' ) ( 'e' | 'E' ) ( 't' | 'T' ) ( 'u' | 'U' ) ( 'r' | 'R' ) ( 'n' | 'N' ) )
			DebugEnterAlt(1);
			// Php.g:621:10: ( 'r' | 'R' ) ( 'e' | 'E' ) ( 't' | 'T' ) ( 'u' | 'U' ) ( 'r' | 'R' ) ( 'n' | 'N' )
			{
	...
	private void mThrow()
	{
		...
		try
		{
			int _type = Throw;
			int _channel = DefaultTokenChannel;
			// Php.g:622:7: ( ( 't' | 'T' ) ( 'h' | 'H' ) ( 'r' | 'R' ) ( 'o' | 'O' ) ( 'w' | 'W' ) )
			DebugEnterAlt(1);
			// Php.g:622:9: ( 't' | 'T' ) ( 'h' | 'H' ) ( 'r' | 'R' ) ( 'o' | 'O' ) ( 'w' | 'W' )
			{
			DebugLocation(622, 9);
			if (input.LA(1)=='T'||input.LA(1)=='t')
			{
	...
	private void mGlobal()
	{
		...
		try
		{
			int _type = Global;
			int _channel = DefaultTokenChannel;
			// Php.g:623:8: ( ( 'g' | 'G' ) ( 'l' | 'L' ) ( 'o' | 'O' ) ( 'b' | 'B' ) ( 'a' | 'A' ) ( 'l' | 'L' ) )
			DebugEnterAlt(1);
			// Php.g:623:10: ( 'g' | 'G' ) ( 'l' | 'L' ) ( 'o' | 'O' ) ( 'b' | 'B' ) ( 'a' | 'A' ) ( 'l' | 'L' )
			{
	...
	private void mStatic()
	{
		...
		try
		{
			int _type = Static;
			int _channel = DefaultTokenChannel;
			// Php.g:624:8: ( ( 's' | 'S' ) ( 't' | 'T' ) ( 'a' | 'A' ) ( 't' | 'T' ) ( 'i' | 'I' ) ( 'c' | 'C' ) )
			DebugEnterAlt(1);
			// Php.g:624:10: ( 's' | 'S' ) ( 't' | 'T' ) ( 'a' | 'A' ) ( 't' | 'T' ) ( 'i' | 'I' ) ( 'c' | 'C' )
			{
	...
	private void mAnd()
	{
		...
		try
		{
			int _type = And;
			int _channel = DefaultTokenChannel;
			// Php.g:625:5: ( ( 'a' | 'A' ) ( 'n' | 'N' ) ( 'd' | 'D' ) )
			DebugEnterAlt(1);
			// Php.g:625:7: ( 'a' | 'A' ) ( 'n' | 'N' ) ( 'd' | 'D' )
			{
			DebugLocation(625, 7);
			if (input.LA(1)=='A'||input.LA(1)=='a')
			{
	...
	private void mXor()
	{
		...
		try
		{
			int _type = Xor;
			int _channel = DefaultTokenChannel;
			// Php.g:627:5: ( ( 'x' | 'X' ) ( 'o' | 'O' ) ( 'r' | 'R' ) )
			DebugEnterAlt(1);
			// Php.g:627:7: ( 'x' | 'X' ) ( 'o' | 'O' ) ( 'r' | 'R' )
			{
			DebugLocation(627, 7);
	...
	private void mInstanceof()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Php.g:628:12: ( ( 'i' | 'I' ) ( 'n' | 'N' ) ( 's' | 'S' ) ( 't' | 'T' ) ( 'a' | 'A' ) ( 'n' | 'N' ) ( 'c' | 'C' ) ( 'e' | 'E' ) ( 'o' | 'O' ) ( 'f' | 'F' ) )
			DebugEnterAlt(1);
			// Php.g:628:14: ( 'i' | 'I' ) ( 'n' | 'N' ) ( 's' | 'S' ) ( 't' | 'T' ) ( 'a' | 'A' ) ( 'n' | 'N' ) ( 'c' | 'C' ) ( 'e' | 'E' ) ( 'o' | 'O' ) ( 'f' | 'F' )
			{
	...
	private void mNull()
	{
		...
		try
		{
			int _type = Null;
			int _channel = DefaultTokenChannel;
			// Php.g:629:6: ( ( 'n' | 'N' ) ( 'u' | 'U' ) ( 'l' | 'L' ) ( 'l' | 'L' ) )
			DebugEnterAlt(1);
			// Php.g:629:8: ( 'n' | 'N' ) ( 'u' | 'U' ) ( 'l' | 'L' ) ( 'l' | 'L' )
			{
			DebugLocation(629, 8);
			if (input.LA(1)=='N'||input.LA(1)=='n')
			{
	...
	private void mList()
	{
		...
		try
		{
			int _type = List;
			int _channel = DefaultTokenChannel;
			// Php.g:630:6: ( ( 'l' | 'L' ) ( 'i' | 'I' ) ( 's' | 'S' ) ( 't' | 'T' ) )
			DebugEnterAlt(1);
			// Php.g:630:8: ( 'l' | 'L' ) ( 'i' | 'I' ) ( 's' | 'S' ) ( 't' | 'T' )
			{
			DebugLocation(630, 8);
			if (input.LA(1)=='L'||input.LA(1)=='l')
			{
	...
	private void mClass()
	{
		...
		try
		{
			int _type = Class;
			int _channel = DefaultTokenChannel;
			// Php.g:631:7: ( ( 'c' | 'C' ) ( 'l' | 'L' ) ( 'a' | 'A' ) ( 's' | 'S' ) ( 's' | 'S' ) )
			DebugEnterAlt(1);
			// Php.g:631:9: ( 'c' | 'C' ) ( 'l' | 'L' ) ( 'a' | 'A' ) ( 's' | 'S' ) ( 's' | 'S' )
			{
			DebugLocation(631, 9);
			if (input.LA(1)=='C'||input.LA(1)=='c')
			{
	...
	private void mInterface()
	{
		...
		try
		{
			int _type = Interface;
			int _channel = DefaultTokenChannel;
			// Php.g:632:11: ( ( 'i' | 'I' ) ( 'n' | 'N' ) ( 't' | 'T' ) ( 'e' | 'E' ) ( 'r' | 'R' ) ( 'f' | 'F' ) ( 'a' | 'A' ) ( 'c' | 'C' ) ( 'e' | 'E' ) )
			DebugEnterAlt(1);
			// Php.g:632:13: ( 'i' | 'I' ) ( 'n' | 'N' ) ( 't' | 'T' ) ( 'e' | 'E' ) ( 'r' | 'R' ) ( 'f' | 'F' ) ( 'a' | 'A' ) ( 'c' | 'C' ) ( 'e' | 'E' )
			{
	...
	private void mExtends()
	{
		...
		try
		{
			int _type = Extends;
			int _channel = DefaultTokenChannel;
			// Php.g:633:9: ( ( 'e' | 'E' ) ( 'x' | 'X' ) ( 't' | 'T' ) ( 'e' | 'E' ) ( 'n' | 'N' ) ( 'd' | 'D' ) ( 's' | 'S' ) )
			DebugEnterAlt(1);
			// Php.g:633:11: ( 'e' | 'E' ) ( 'x' | 'X' ) ( 't' | 'T' ) ( 'e' | 'E' ) ( 'n' | 'N' ) ( 'd' | 'D' ) ( 's' | 'S' )
			{
	...
	private void mImplements()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Php.g:634:12: ( ( 'i' | 'I' ) ( 'm' | 'M' ) ( 'p' | 'P' ) ( 'l' | 'L' ) ( 'e' | 'E' ) ( 'm' | 'M' ) ( 'e' | 'E' ) ( 'n' | 'N' ) ( 't' | 'T' ) ( 's' | 'S' ) )
			DebugEnterAlt(1);
			// Php.g:634:14: ( 'i' | 'I' ) ( 'm' | 'M' ) ( 'p' | 'P' ) ( 'l' | 'L' ) ( 'e' | 'E' ) ( 'm' | 'M' ) ( 'e' | 'E' ) ( 'n' | 'N' ) ( 't' | 'T' ) ( 's' | 'S' )
			{
	...
	private void mFinal()
	{
		...
		try
		{
			int _type = Final;
			int _channel = DefaultTokenChannel;
			// Php.g:635:7: ( ( 'f' | 'F' ) ( 'i' | 'I' ) ( 'n' | 'N' ) ( 'a' | 'A' ) ( 'l' | 'L' ) )
			DebugEnterAlt(1);
			// Php.g:635:9: ( 'f' | 'F' ) ( 'i' | 'I' ) ( 'n' | 'N' ) ( 'a' | 'A' ) ( 'l' | 'L' )
			{
			DebugLocation(635, 9);
			if (input.LA(1)=='F'||input.LA(1)=='f')
			{
	...
	private void mAbstract()
	{
		...
		try
		{
			int _type = Abstract;
			int _channel = DefaultTokenChannel;
			// Php.g:636:10: ( ( 'a' | 'A' ) ( 'b' | 'B' ) ( 's' | 'S' ) ( 't' | 'T' ) ( 'r' | 'R' ) ( 'a' | 'A' ) ( 'c' | 'C' ) ( 't' | 'T' ) )
			DebugEnterAlt(1);
			// Php.g:636:12: ( 'a' | 'A' ) ( 'b' | 'B' ) ( 's' | 'S' ) ( 't' | 'T' ) ( 'r' | 'R' ) ( 'a' | 'A' ) ( 'c' | 'C' ) ( 't' | 'T' )
			{
	...
	private void mVar()
	{
		...
		try
		{
			int _type = Var;
			int _channel = DefaultTokenChannel;
			// Php.g:637:5: ( ( 'v' | 'V' ) ( 'a' | 'A' ) ( 'r' | 'R' ) )
			DebugEnterAlt(1);
			// Php.g:637:7: ( 'v' | 'V' ) ( 'a' | 'A' ) ( 'r' | 'R' )
			{
			DebugLocation(637, 7);
	...
	private void mConst()
	{
		...
		try
		{
			int _type = Const;
			int _channel = DefaultTokenChannel;
			// Php.g:638:7: ( ( 'c' | 'C' ) ( 'o' | 'O' ) ( 'n' | 'N' ) ( 's' | 'S' ) ( 't' | 'T' ) )
			DebugEnterAlt(1);
			// Php.g:638:9: ( 'c' | 'C' ) ( 'o' | 'O' ) ( 'n' | 'N' ) ( 's' | 'S' ) ( 't' | 'T' )
			{
			DebugLocation(638, 9);
			if (input.LA(1)=='C'||input.LA(1)=='c')
			{
	...
	private void mUse()
	{
		...
		try
		{
			int _type = Use;
			int _channel = DefaultTokenChannel;
			// Php.g:640:5: ( ( 'u' | 'U' ) ( 's' | 'S' ) ( 'e' | 'E' ) )
			DebugEnterAlt(1);
			// Php.g:640:7: ( 'u' | 'U' ) ( 's' | 'S' ) ( 'e' | 'E' )
			{
			DebugLocation(640, 7);
			if (input.LA(1)=='U'||input.LA(1)=='u')
			{
	...
	private void mRequire()
	{
		...
		try
		{
			int _type = Require;
			int _channel = DefaultTokenChannel;
			// Php.g:642:9: ( ( 'r' | 'R' ) ( 'e' | 'E' ) ( 'q' | 'Q' ) ( 'u' | 'U' ) ( 'i' | 'I' ) ( 'r' | 'R' ) ( 'e' | 'E' ) )
			DebugEnterAlt(1);
			// Php.g:642:11: ( 'r' | 'R' ) ( 'e' | 'E' ) ( 'q' | 'Q' ) ( 'u' | 'U' ) ( 'i' | 'I' ) ( 'r' | 'R' ) ( 'e' | 'E' )
			{
	...
	private void mRequireOnce()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Php.g:643:13: ( ( 'r' | 'R' ) ( 'e' | 'E' ) ( 'q' | 'Q' ) ( 'u' | 'U' ) ( 'i' | 'I' ) ( 'r' | 'R' ) ( 'e' | 'E' ) '_' ( 'o' | 'O' ) ( 'n' | 'N' ) ( 'c' | 'C' ) ( 'e' | 'E' ) )
			DebugEnterAlt(1);
			// Php.g:643:15: ( 'r' | 'R' ) ( 'e' | 'E' ) ( 'q' | 'Q' ) ( 'u' | 'U' ) ( 'i' | 'I' ) ( 'r' | 'R' ) ( 'e' | 'E' ) '_' ( 'o' | 'O' ) ( 'n' | 'N' ) ( 'c' | 'C' ) ( 'e' | 'E' )
			{
	...
	private void mInclude()
	{
		...
		try
		{
			int _type = Include;
			int _channel = DefaultTokenChannel;
			// Php.g:644:9: ( ( 'i' | 'I' ) ( 'n' | 'N' ) ( 'c' | 'C' ) ( 'l' | 'L' ) ( 'u' | 'U' ) ( 'd' | 'D' ) ( 'e' | 'E' ) )
			DebugEnterAlt(1);
			// Php.g:644:11: ( 'i' | 'I' ) ( 'n' | 'N' ) ( 'c' | 'C' ) ( 'l' | 'L' ) ( 'u' | 'U' ) ( 'd' | 'D' ) ( 'e' | 'E' )
			{
	...
	private void mIncludeOnce()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Php.g:645:13: ( ( 'i' | 'I' ) ( 'n' | 'N' ) ( 'c' | 'C' ) ( 'l' | 'L' ) ( 'u' | 'U' ) ( 'd' | 'D' ) ( 'e' | 'E' ) '_' ( 'o' | 'O' ) ( 'n' | 'N' ) ( 'c' | 'C' ) ( 'e' | 'E' ) )
			DebugEnterAlt(1);
			// Php.g:645:15: ( 'i' | 'I' ) ( 'n' | 'N' ) ( 'c' | 'C' ) ( 'l' | 'L' ) ( 'u' | 'U' ) ( 'd' | 'D' ) ( 'e' | 'E' ) '_' ( 'o' | 'O' ) ( 'n' | 'N' ) ( 'c' | 'C' ) ( 'e' | 'E' )
			{
	...
	private void mPublic()
	{
		...
		try
		{
			int _type = Public;
			int _channel = DefaultTokenChannel;
			// Php.g:646:8: ( ( 'p' | 'P' ) ( 'u' | 'U' ) ( 'b' | 'B' ) ( 'l' | 'L' ) ( 'i' | 'I' ) ( 'c' | 'C' ) )
			DebugEnterAlt(1);
			// Php.g:646:10: ( 'p' | 'P' ) ( 'u' | 'U' ) ( 'b' | 'B' ) ( 'l' | 'L' ) ( 'i' | 'I' ) ( 'c' | 'C' )
			{
	...
	private void mPrivate()
	{
		...
		try
		{
			int _type = Private;
			int _channel = DefaultTokenChannel;
			// Php.g:647:9: ( ( 'p' | 'P' ) ( 'r' | 'R' ) ( 'i' | 'I' ) ( 'v' | 'V' ) ( 'a' | 'A' ) ( 't' | 'T' ) ( 'e' | 'E' ) )
			DebugEnterAlt(1);
			// Php.g:647:11: ( 'p' | 'P' ) ( 'r' | 'R' ) ( 'i' | 'I' ) ( 'v' | 'V' ) ( 'a' | 'A' ) ( 't' | 'T' ) ( 'e' | 'E' )
			{
	...
	private void mProtected()
	{
		...
		try
		{
			int _type = Protected;
			int _channel = DefaultTokenChannel;
			// Php.g:648:11: ( ( 'p' | 'P' ) ( 'r' | 'R' ) ( 'o' | 'O' ) ( 't' | 'T' ) ( 'e' | 'E' ) ( 'c' | 'C' ) ( 't' | 'T' ) ( 'e' | 'E' ) ( 'd' | 'D' ) )
			DebugEnterAlt(1);
			// Php.g:648:13: ( 'p' | 'P' ) ( 'r' | 'R' ) ( 'o' | 'O' ) ( 't' | 'T' ) ( 'e' | 'E' ) ( 'c' | 'C' ) ( 't' | 'T' ) ( 'e' | 'E' ) ( 'd' | 'D' )
			{
	...
	private void mTrue()
	{
		...
		try
		{
			int _type = True;
			int _channel = DefaultTokenChannel;
			// Php.g:649:6: ( ( 't' | 'T' ) ( 'r' | 'R' ) ( 'u' | 'U' ) ( 'e' | 'E' ) )
			DebugEnterAlt(1);
			// Php.g:649:8: ( 't' | 'T' ) ( 'r' | 'R' ) ( 'u' | 'U' ) ( 'e' | 'E' )
			{
			DebugLocation(649, 8);
			if (input.LA(1)=='T'||input.LA(1)=='t')
			{
	...
	private void mFalse()
	{
		...
		try
		{
			int _type = False;
			int _channel = DefaultTokenChannel;
			// Php.g:650:7: ( ( 'f' | 'F' ) ( 'a' | 'A' ) ( 'l' | 'L' ) ( 's' | 'S' ) ( 'e' | 'E' ) )
			DebugEnterAlt(1);
			// Php.g:650:9: ( 'f' | 'F' ) ( 'a' | 'A' ) ( 'l' | 'L' ) ( 's' | 'S' ) ( 'e' | 'E' )
			{
			DebugLocation(650, 9);
			if (input.LA(1)=='F'||input.LA(1)=='f')
			{
	...
	private void mHaltCompiler()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Php.g:651:14: ( '_' '_' ( 'h' | 'H' ) ( 'a' | 'A' ) ( 'l' | 'L' ) ( 't' | 'T' ) '_' ( 'c' | 'C' ) ( 'o' | 'O' ) ( 'm' | 'M' ) ( 'p' | 'P' ) ( 'i' | 'I' ) ( 'l' | 'L' ) ( 'e' | 'E' ) ( 'r' | 'R' ) )
			DebugEnterAlt(1);
			// Php.g:651:16: '_' '_' ( 'h' | 'H' ) ( 'a' | 'A' ) ( 'l' | 'L' ) ( 't' | 'T' ) '_' ( 'c' | 'C' ) ( 'o' | 'O' ) ( 'm' | 'M' ) ( 'p' | 'P' ) ( 'i' | 'I' ) ( 'l' | 'L' ) ( 'e' | 'E' ) ( 'r' | 'R' )
			{
	...
	private void mDie()
	{
		...
		try
		{
			int _type = Die;
			int _channel = DefaultTokenChannel;
			// Php.g:652:5: ( ( 'd' | 'D' ) ( 'i' | 'I' ) ( 'e' | 'E' ) )
			DebugEnterAlt(1);
			// Php.g:652:7: ( 'd' | 'D' ) ( 'i' | 'I' ) ( 'e' | 'E' )
			{
			DebugLocation(652, 7);
			if (input.LA(1)=='D'||input.LA(1)=='d')
			{
	...
	private void mEmpty()
	{
		...
		try
		{
			int _type = Empty;
			int _channel = DefaultTokenChannel;
			// Php.g:653:7: ( ( 'e' | 'E' ) ( 'm' | 'M' ) ( 'p' | 'P' ) ( 't' | 'T' ) ( 'y' | 'Y' ) )
			DebugEnterAlt(1);
			// Php.g:653:9: ( 'e' | 'E' ) ( 'm' | 'M' ) ( 'p' | 'P' ) ( 't' | 'T' ) ( 'y' | 'Y' )
			{
			DebugLocation(653, 9);
			if (input.LA(1)=='E'||input.LA(1)=='e')
			{
	...
	private void mExit()
	{
		...
		try
		{
			int _type = Exit;
			int _channel = DefaultTokenChannel;
			// Php.g:654:6: ( ( 'e' | 'E' ) ( 'x' | 'X' ) ( 'i' | 'I' ) ( 't' | 'T' ) )
			DebugEnterAlt(1);
			// Php.g:654:8: ( 'e' | 'E' ) ( 'x' | 'X' ) ( 'i' | 'I' ) ( 't' | 'T' )
			{
			DebugLocation(654, 8);
			if (input.LA(1)=='E'||input.LA(1)=='e')
			{
	...
	private void mEval()
	{
		...
		try
		{
			int _type = Eval;
			int _channel = DefaultTokenChannel;
			// Php.g:655:6: ( ( 'e' | 'E' ) ( 'v' | 'V' ) ( 'a' | 'A' ) ( 'l' | 'L' ) )
			DebugEnterAlt(1);
			// Php.g:655:8: ( 'e' | 'E' ) ( 'v' | 'V' ) ( 'a' | 'A' ) ( 'l' | 'L' )
			{
			DebugLocation(655, 8);
			if (input.LA(1)=='E'||input.LA(1)=='e')
			{
	...
	private void mIsset()
	{
		...
		try
		{
			int _type = Isset;
			int _channel = DefaultTokenChannel;
			// Php.g:656:7: ( ( 'i' | 'I' ) ( 's' | 'S' ) ( 's' | 'S' ) ( 'e' | 'E' ) ( 't' | 'T' ) )
			DebugEnterAlt(1);
			// Php.g:656:9: ( 'i' | 'I' ) ( 's' | 'S' ) ( 's' | 'S' ) ( 'e' | 'E' ) ( 't' | 'T' )
			{
			DebugLocation(656, 9);
			if (input.LA(1)=='I'||input.LA(1)=='i')
			{
	...
	private void mHexadecimal()
	{
		...
		try
		{
			// Php.g:665:2: ( '0' ( 'x' | 'X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ )
			DebugEnterAlt(1);
			// Php.g:665:4: '0' ( 'x' | 'X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+
			{
			DebugLocation(665, 4);
			Match('0'); if (state.failed) return;
			DebugLocation(665, 7);
	...
	private void mInteger()
	{
		...
		try
		{
			int _type = Integer;
			int _channel = DefaultTokenChannel;
			// Php.g:672:2: ( Octal | Decimal | Hexadecimal )
			int alt15=3;
	...
	private void mDNum()
	{
		...
		try
		{
			// Php.g:683:2: ( ( ( '.' Digits )=> ( '.' Digits ) | ( Digits '.' ( Digits )? ) ) )
			DebugEnterAlt(1);
			// Php.g:683:3: ( ( '.' Digits )=> ( '.' Digits ) | ( Digits '.' ( Digits )? ) )
			{
			DebugLocation(683, 3);
			// Php.g:683:3: ( ( '.' Digits )=> ( '.' Digits ) | ( Digits '.' ( Digits )? ) )
			int alt18=2;
			...
			case 2:
				DebugEnterAlt(2);
				// Php.g:683:31: ( Digits '.' ( Digits )? )
				{
				DebugLocation(683, 31);
				// Php.g:683:31: ( Digits '.' ( Digits )? )
				DebugEnterAlt(1);
				// Php.g:683:32: Digits '.' ( Digits )?
				{
	...
	private void mExponent_DNum()
	{
		...
		try
		{
			// Php.g:688:2: ( ( ( Digits | DNum ) ( 'e' | 'E' ) ( '+' '-' )? Digits ) )
			DebugEnterAlt(1);
			// Php.g:688:3: ( ( Digits | DNum ) ( 'e' | 'E' ) ( '+' '-' )? Digits )
			{
			DebugLocation(688, 3);
			// Php.g:688:3: ( ( Digits | DNum ) ( 'e' | 'E' ) ( '+' '-' )? Digits )
			DebugEnterAlt(1);
			// Php.g:688:4: ( Digits | DNum ) ( 'e' | 'E' ) ( '+' '-' )? Digits
			{
			DebugLocation(688, 4);
			// Php.g:688:4: ( Digits | DNum )
			int alt19=2;
	...
	private void mReal()
	{
		...
		try
		{
			int _type = Real;
			int _channel = DefaultTokenChannel;
			// Php.g:691:2: ( DNum | Exponent_DNum )
			int alt21=2;
	...
	private void mDoubleQuotedString()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Php.g:707:2: ( '\"' ( ( '\\\\' EscapeCharector )=> '\\\\' EscapeCharector | '\\\\' |~ ( '\\\\' | '\"' ) )* '\"' )
			DebugEnterAlt(1);
			// Php.g:707:4: '\"' ( ( '\\\\' EscapeCharector )=> '\\\\' EscapeCharector | '\\\\' |~ ( '\\\\' | '\"' ) )* '\"'
			{
			DebugLocation(707, 4);
			Match('\"'); if (state.failed) return;
			DebugLocation(707, 9);
			// Php.g:707:9: ( ( '\\\\' EscapeCharector )=> '\\\\' EscapeCharector | '\\\\' |~ ( '\\\\' | '\"' ) )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// Php.g:707:11: ( '\\\\' EscapeCharector )=> '\\\\' EscapeCharector
					{
	...
	private void mHereDoc()
	{
		...
		try
		{
			int _type = HereDoc;
			int _channel = DefaultTokenChannel;
			// Php.g:714:2: ( '<<<' HereDocContents )
			DebugEnterAlt(1);
			// Php.g:714:4: '<<<' HereDocContents
			{
			DebugLocation(714, 4);
			Match("<<<"); if (state.failed) return;
	...
	private void mVariableName()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Php.g:719:2: ( '$' UnquotedStringBody )
			DebugEnterAlt(1);
			// Php.g:719:4: '$' UnquotedStringBody
			{
			DebugLocation(719, 4);
			Match('$'); if (state.failed) return;
			DebugLocation(719, 8);
	...
	private void mUnquotedString()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Php.g:724:4: ( UnquotedStringBody )
			DebugEnterAlt(1);
			// Php.g:724:6: UnquotedStringBody
			{
			DebugLocation(724, 6);
			mUnquotedStringBody(); if (state.failed) return;
	...
	private void mUnquotedStringBody()
	{
		...
		try
		{
			// Php.g:730:4: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
			DebugEnterAlt(1);
			// Php.g:730:6: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			{
			DebugLocation(730, 6);
	...
	public override void mTokens()
	{
		...
		case 106:
			DebugEnterAlt(106);
			// Php.g:1:887: SingleQuotedString
			{
			DebugLocation(1, 887);
		...
		case 107:
			DebugEnterAlt(107);
			// Php.g:1:906: DoubleQuotedString
			{
			DebugLocation(1, 906);
		...
		case 113:
			DebugEnterAlt(113);
			// Php.g:1:996: ComparisionOperator
			{
			DebugLocation(1, 996);
		...
		case 115:
			DebugEnterAlt(115);
			// Php.g:1:1030: IncrementOperator
			{
	...
	private void synpred9_Php_fragment()
	{
		...
		try
		{
			// Php.g:707:11: ( '\\\\' EscapeCharector )
			DebugEnterAlt(1);
			// Php.g:707:12: '\\\\' EscapeCharector
			{
