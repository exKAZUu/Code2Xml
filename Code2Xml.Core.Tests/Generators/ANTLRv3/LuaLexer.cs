...
public partial class LuaLexer : Antlr.Runtime.Lexer
{
	...
	private void mNAME()
	{
		...
		try
		{
			int _type = NAME;
			int _channel = DefaultTokenChannel;
			// Lua.g:204:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
			DebugEnterAlt(1);
			// Lua.g:204:7: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
			{
			DebugLocation(204, 7);
	...
	private void mNORMALSTRING()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Lua.g:208:5: ( '\"' ( EscapeSequence |~ ( '\\\\' | '\"' ) )* '\"' )
			DebugEnterAlt(1);
			// Lua.g:208:7: '\"' ( EscapeSequence |~ ( '\\\\' | '\"' ) )* '\"'
			{
			DebugLocation(208, 7);
			Match('\"'); 
			DebugLocation(208, 11);
			// Lua.g:208:11: ( EscapeSequence |~ ( '\\\\' | '\"' ) )*
	...
	private void mCHARSTRING()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Lua.g:212:5: ( '\\'' ( EscapeSequence |~ ( '\\'' | '\\\\' ) )* '\\'' )
			DebugEnterAlt(1);
			// Lua.g:212:7: '\\'' ( EscapeSequence |~ ( '\\'' | '\\\\' ) )* '\\''
			{
			DebugLocation(212, 7);
			Match('\''); 
			DebugLocation(212, 12);
			// Lua.g:212:12: ( EscapeSequence |~ ( '\\'' | '\\\\' ) )*
	...
	private void mLONGSTRING()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Lua.g:217:5: ( '[[' ( options {greedy=false; } : . )* ']]' | '[=[' ( options {greedy=false; } : . )* ']=]' | '[==[' ( options {greedy=false; } : . )* ']==]' | '[===[' ( options {greedy=false; } : . )* ']===]' | '[====[' ( options {greedy=false; } : . )* ']====]' | '[=====[' ( options {greedy=false; } : . )* ']=====]' | '[======[' ( options {greedy=false; } : . )* ']======]' | '[=======[' ( options {greedy=false; } : . )* ']=======]' | '[========[' ( options {greedy=false; } : . )* ']========]' | '[=========[' ( options {greedy=false; } : . )* ']=========]' | '[==========[' ( options {greedy=false; } : . )* ']==========]' )
			int alt15=11;
			...
			case 1:
				DebugEnterAlt(1);
				// Lua.g:217:7: '[[' ( options {greedy=false; } : . )* ']]'
				{
				DebugLocation(217, 7);
				Match("[["); 

				DebugLocation(217, 12);
				// Lua.g:217:12: ( options {greedy=false; } : . )*
			...
			case 2:
				DebugEnterAlt(2);
				// Lua.g:218:7: '[=[' ( options {greedy=false; } : . )* ']=]'
				{
				DebugLocation(218, 7);
				Match("[=["); 

				DebugLocation(218, 13);
				// Lua.g:218:13: ( options {greedy=false; } : . )*
			...
			case 3:
				DebugEnterAlt(3);
				// Lua.g:219:7: '[==[' ( options {greedy=false; } : . )* ']==]'
				{
				DebugLocation(219, 7);
				Match("[==["); 

				DebugLocation(219, 14);
				// Lua.g:219:14: ( options {greedy=false; } : . )*
			...
			case 4:
				DebugEnterAlt(4);
				// Lua.g:220:7: '[===[' ( options {greedy=false; } : . )* ']===]'
				{
				DebugLocation(220, 7);
				Match("[===["); 

				DebugLocation(220, 15);
				// Lua.g:220:15: ( options {greedy=false; } : . )*
			...
			case 5:
				DebugEnterAlt(5);
				// Lua.g:221:7: '[====[' ( options {greedy=false; } : . )* ']====]'
				{
				DebugLocation(221, 7);
				Match("[====["); 

				DebugLocation(221, 16);
				// Lua.g:221:16: ( options {greedy=false; } : . )*
			...
			case 6:
				DebugEnterAlt(6);
				// Lua.g:222:7: '[=====[' ( options {greedy=false; } : . )* ']=====]'
				{
				DebugLocation(222, 7);
				Match("[=====["); 

				DebugLocation(222, 17);
				// Lua.g:222:17: ( options {greedy=false; } : . )*
			...
			case 7:
				DebugEnterAlt(7);
				// Lua.g:223:7: '[======[' ( options {greedy=false; } : . )* ']======]'
				{
				DebugLocation(223, 7);
				Match("[======["); 

				DebugLocation(223, 18);
				// Lua.g:223:18: ( options {greedy=false; } : . )*
			...
			case 8:
				DebugEnterAlt(8);
				// Lua.g:224:7: '[=======[' ( options {greedy=false; } : . )* ']=======]'
				{
				DebugLocation(224, 7);
				Match("[=======["); 

				DebugLocation(224, 19);
				// Lua.g:224:19: ( options {greedy=false; } : . )*
			...
			case 9:
				DebugEnterAlt(9);
				// Lua.g:225:7: '[========[' ( options {greedy=false; } : . )* ']========]'
				{
				DebugLocation(225, 7);
				Match("[========["); 

				DebugLocation(225, 20);
				// Lua.g:225:20: ( options {greedy=false; } : . )*
			...
			case 10:
				DebugEnterAlt(10);
				// Lua.g:226:7: '[=========[' ( options {greedy=false; } : . )* ']=========]'
				{
				DebugLocation(226, 7);
				Match("[=========["); 

				DebugLocation(226, 21);
				// Lua.g:226:21: ( options {greedy=false; } : . )*
			...
			case 11:
				DebugEnterAlt(11);
				// Lua.g:227:7: '[==========[' ( options {greedy=false; } : . )* ']==========]'
				{
				DebugLocation(227, 7);
				Match("[==========["); 

				DebugLocation(227, 22);
				// Lua.g:227:22: ( options {greedy=false; } : . )*
	...
	private void mHEX()
	{
		...
		try
		{
			int _type = HEX;
			int _channel = DefaultTokenChannel;
			// Lua.g:235:5: ( '0' ( 'x' | 'X' ) ( HexDigit )+ )
			DebugEnterAlt(1);
			// Lua.g:235:7: '0' ( 'x' | 'X' ) ( HexDigit )+
			{
			DebugLocation(235, 7);
			Match('0'); 
	...
	private void mFLOAT()
	{
		...
		try
		{
			int _type = FLOAT;
			int _channel = DefaultTokenChannel;
			// Lua.g:239:5: ( ( Digit )+ '.' ( Digit )* ( ExponentPart )? | '.' ( Digit )+ ( ExponentPart )? | ( Digit )+ ExponentPart )
			int alt24=3;
			...
			case 1:
				DebugEnterAlt(1);
				// Lua.g:239:7: ( Digit )+ '.' ( Digit )* ( ExponentPart )?
				{
				DebugLocation(239, 7);
				// Lua.g:239:7: ( Digit )+
				int cnt18=0;
			...
			case 2:
				DebugEnterAlt(2);
				// Lua.g:240:7: '.' ( Digit )+ ( ExponentPart )?
				{
				DebugLocation(240, 7);
				Match('.'); 
			...
			case 3:
				DebugEnterAlt(3);
				// Lua.g:241:7: ( Digit )+ ExponentPart
				{
				DebugLocation(241, 7);
				// Lua.g:241:7: ( Digit )+
				int cnt23=0;
	...
	private void mHEX_FLOAT()
	{
		...
		try
		{
			int _type = HEX_FLOAT;
			int _channel = DefaultTokenChannel;
			// Lua.g:245:5: ( '0' ( 'x' | 'X' ) ( HexDigit )+ '.' ( HexDigit )* ( HexExponentPart )? | '0' ( 'x' | 'X' ) '.' ( HexDigit )+ ( HexExponentPart )? | '0' ( 'x' | 'X' ) ( HexDigit )+ HexExponentPart )
			int alt31=3;
			...
			case 1:
				DebugEnterAlt(1);
				// Lua.g:245:7: '0' ( 'x' | 'X' ) ( HexDigit )+ '.' ( HexDigit )* ( HexExponentPart )?
				{
				DebugLocation(245, 7);
				Match('0'); 
			...
			case 2:
				DebugEnterAlt(2);
				// Lua.g:246:7: '0' ( 'x' | 'X' ) '.' ( HexDigit )+ ( HexExponentPart )?
				{
				DebugLocation(246, 7);
				Match('0'); 
			...
			case 3:
				DebugEnterAlt(3);
				// Lua.g:247:7: '0' ( 'x' | 'X' ) ( HexDigit )+ HexExponentPart
				{
				DebugLocation(247, 7);
				Match('0'); 
	...
	private void mExponentPart()
	{
		...
		try
		{
			// Lua.g:253:5: ( ( 'e' | 'E' ) ( '+' | '-' )? ( Digit )+ )
			DebugEnterAlt(1);
			// Lua.g:253:7: ( 'e' | 'E' ) ( '+' | '-' )? ( Digit )+
			{
			DebugLocation(253, 7);
	...
	private void mHexExponentPart()
	{
		...
		try
		{
			// Lua.g:258:5: ( ( 'p' | 'P' ) ( '+' | '-' )? ( Digit )+ )
			DebugEnterAlt(1);
			// Lua.g:258:7: ( 'p' | 'P' ) ( '+' | '-' )? ( Digit )+
			{
			DebugLocation(258, 7);
	...
	private void mDecimalEscape()
	{
		...
		try
		{
			// Lua.g:271:5: ( '\\\\' Digit | '\\\\' Digit Digit | '\\\\' '0' .. '2' Digit Digit )
			int alt38=3;
	...
	private void mHexEscape()
	{
		...
		try
		{
			// Lua.g:278:5: ( '\\\\' 'x' HexDigit HexDigit )
			DebugEnterAlt(1);
			// Lua.g:278:7: '\\\\' 'x' HexDigit HexDigit
			{
			DebugLocation(278, 7);
			Match('\\'); 
	...
	private void mCOMMENT()
	{
		...
		try
		{
			int _type = COMMENT;
			int _channel = DefaultTokenChannel;
			// Lua.g:291:5: ( '--' ( '[[' ( options {greedy=false; } : . )* ']]' | '[=[' ( options {greedy=false; } : . )* ']=]' | '[==[' ( options {greedy=false; } : . )* ']==]' | '[===[' ( options {greedy=false; } : . )* ']===]' | '[====[' ( options {greedy=false; } : . )* ']====]' | '[=====[' ( options {greedy=false; } : . )* ']=====]' | '[======[' ( options {greedy=false; } : . )* ']======]' | '[=======[' ( options {greedy=false; } : . )* ']=======]' | '[========[' ( options {greedy=false; } : . )* ']========]' | '[=========[' ( options {greedy=false; } : . )* ']=========]' | '[==========[' ( options {greedy=false; } : . )* ']==========]' ) )
			DebugEnterAlt(1);
			// Lua.g:291:7: '--' ( '[[' ( options {greedy=false; } : . )* ']]' | '[=[' ( options {greedy=false; } : . )* ']=]' | '[==[' ( options {greedy=false; } : . )* ']==]' | '[===[' ( options {greedy=false; } : . )* ']===]' | '[====[' ( options {greedy=false; } : . )* ']====]' | '[=====[' ( options {greedy=false; } : . )* ']=====]' | '[======[' ( options {greedy=false; } : . )* ']======]' | '[=======[' ( options {greedy=false; } : . )* ']=======]' | '[========[' ( options {greedy=false; } : . )* ']========]' | '[=========[' ( options {greedy=false; } : . )* ']=========]' | '[==========[' ( options {greedy=false; } : . )* ']==========]' )
			{
			DebugLocation(291, 7);
			Match("--"); 

			DebugLocation(292, 2);
			// Lua.g:292:2: ( '[[' ( options {greedy=false; } : . )* ']]' | '[=[' ( options {greedy=false; } : . )* ']=]' | '[==[' ( options {greedy=false; } : . )* ']==]' | '[===[' ( options {greedy=false; } : . )* ']===]' | '[====[' ( options {greedy=false; } : . )* ']====]' | '[=====[' ( options {greedy=false; } : . )* ']=====]' | '[======[' ( options {greedy=false; } : . )* ']======]' | '[=======[' ( options {greedy=false; } : . )* ']=======]' | '[========[' ( options {greedy=false; } : . )* ']========]' | '[=========[' ( options {greedy=false; } : . )* ']=========]' | '[==========[' ( options {greedy=false; } : . )* ']==========]' )
			int alt50=11;
			...
			case 1:
				DebugEnterAlt(1);
				// Lua.g:292:4: '[[' ( options {greedy=false; } : . )* ']]'
				{
				DebugLocation(292, 4);
				Match("[["); 

				DebugLocation(292, 9);
				// Lua.g:292:9: ( options {greedy=false; } : . )*
			...
			case 2:
				DebugEnterAlt(2);
				// Lua.g:293:7: '[=[' ( options {greedy=false; } : . )* ']=]'
				{
				DebugLocation(293, 7);
				Match("[=["); 

				DebugLocation(293, 13);
				// Lua.g:293:13: ( options {greedy=false; } : . )*
			...
			case 3:
				DebugEnterAlt(3);
				// Lua.g:294:7: '[==[' ( options {greedy=false; } : . )* ']==]'
				{
				DebugLocation(294, 7);
				Match("[==["); 

				DebugLocation(294, 14);
				// Lua.g:294:14: ( options {greedy=false; } : . )*
			...
			case 4:
				DebugEnterAlt(4);
				// Lua.g:295:7: '[===[' ( options {greedy=false; } : . )* ']===]'
				{
				DebugLocation(295, 7);
				Match("[===["); 

				DebugLocation(295, 15);
				// Lua.g:295:15: ( options {greedy=false; } : . )*
			...
			case 5:
				DebugEnterAlt(5);
				// Lua.g:296:7: '[====[' ( options {greedy=false; } : . )* ']====]'
				{
				DebugLocation(296, 7);
				Match("[====["); 

				DebugLocation(296, 16);
				// Lua.g:296:16: ( options {greedy=false; } : . )*
			...
			case 6:
				DebugEnterAlt(6);
				// Lua.g:297:7: '[=====[' ( options {greedy=false; } : . )* ']=====]'
				{
				DebugLocation(297, 7);
				Match("[=====["); 

				DebugLocation(297, 17);
				// Lua.g:297:17: ( options {greedy=false; } : . )*
			...
			case 7:
				DebugEnterAlt(7);
				// Lua.g:298:7: '[======[' ( options {greedy=false; } : . )* ']======]'
				{
				DebugLocation(298, 7);
				Match("[======["); 

				DebugLocation(298, 18);
				// Lua.g:298:18: ( options {greedy=false; } : . )*
			...
			case 8:
				DebugEnterAlt(8);
				// Lua.g:299:7: '[=======[' ( options {greedy=false; } : . )* ']=======]'
				{
				DebugLocation(299, 7);
				Match("[=======["); 

				DebugLocation(299, 19);
				// Lua.g:299:19: ( options {greedy=false; } : . )*
			...
			case 9:
				DebugEnterAlt(9);
				// Lua.g:300:7: '[========[' ( options {greedy=false; } : . )* ']========]'
				{
				DebugLocation(300, 7);
				Match("[========["); 

				DebugLocation(300, 20);
				// Lua.g:300:20: ( options {greedy=false; } : . )*
			...
			case 10:
				DebugEnterAlt(10);
				// Lua.g:301:7: '[=========[' ( options {greedy=false; } : . )* ']=========]'
				{
				DebugLocation(301, 7);
				Match("[=========["); 

				DebugLocation(301, 21);
				// Lua.g:301:21: ( options {greedy=false; } : . )*
			...
			case 11:
				DebugEnterAlt(11);
				// Lua.g:302:7: '[==========[' ( options {greedy=false; } : . )* ']==========]'
				{
				DebugLocation(302, 7);
				Match("[==========["); 

				DebugLocation(302, 22);
				// Lua.g:302:22: ( options {greedy=false; } : . )*
