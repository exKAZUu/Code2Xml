...
namespace Code2Xml.Learner.Core.Learning.Experiments {
	...
	public class JavaScriptExperiment : Experiment {
		...
		private static readonly LearningExperiment[] Experiments = {
            ...
            new JavaScriptSuperComplexBranchExperiment(), // OK(40/50) => NG
            ...
            //new JavaScriptSuperComplexBranchExperimentWithSwitch(), // OK(40/50) => NG
            //new JavaScriptSuperComplexBranchExperimentWithSwitchWithoutTrue(), // OK(40/50) => NG
