...
namespace Code2Xml.AntlrHelper {
	public static class ParserModifier {
		...
		public static string ModifyTraceIn(string code) {
			...
			return TraceInRegex.Replace(code, "var retval = new XAstParserRuleReturnScope($1)").Replace("AstParserRuleReturnScope<object, IToken> retval = new AstParserRuleReturnScope<object, IToken>();", "");
		}
