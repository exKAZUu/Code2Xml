                                                                                            ...
                                                                                            <unaryExpression>
                                                                                              <unaryExpressionNotPlusMinus>
                                                                                                <primary>
                                                                                                  <literal>
                                                                                                    <intLiteral>
                                                                                                      <INTLITERAL startline="13" startpos="35">2</INTLITERAL>
                                                                                                    </intLiteral>
                                                                                                  </literal>
                                                                                                </primary>
                                                                                              </unaryExpressionNotPlusMinus>
                                                                                    ...
                                                                                    <unaryExpression>
                                                                                      <unaryExpressionNotPlusMinus>
                                                                                        <primary>
                                                                                          <literal>
                                                                                            <intLiteral>
                                                                                              <INTLITERAL startline="14" startpos="11">0</INTLITERAL>
                                                                                            </intLiteral>
                                                                                          </literal>
                                                                                        </primary>
                                                                                      </unaryExpressionNotPlusMinus>
                                                                                            ...
                                                                                            <unaryExpression>
                                                                                              <unaryExpressionNotPlusMinus>
                                                                                                <primary>
                                                                                                  <literal>
                                                                                                    <stringLiteral>
                                                                                                      <STRINGLITERAL startline="14" startpos="28">"Tom"</STRINGLITERAL>
                                                                                                    </stringLiteral>
                                                                                                  </literal>
                                                                                                </primary>
                                                                                              </unaryExpressionNotPlusMinus>
                                                                                    ...
                                                                                    <unaryExpression>
                                                                                      <unaryExpressionNotPlusMinus>
                                                                                        <primary>
                                                                                          <literal>
                                                                                            <intLiteral>
                                                                                              <INTLITERAL startline="15" startpos="11">1</INTLITERAL>
                                                                                            </intLiteral>
                                                                                          </literal>
                                                                                        </primary>
                                                                                      </unaryExpressionNotPlusMinus>
                                                                                            ...
                                                                                            <unaryExpression>
                                                                                              <unaryExpressionNotPlusMinus>
                                                                                                <primary>
                                                                                                  <literal>
                                                                                                    <stringLiteral>
                                                                                                      <STRINGLITERAL startline="15" startpos="28">"Anna"</STRINGLITERAL>
                                                                                                    </stringLiteral>
                                                                                                  </literal>
                                                                                                </primary>
                                                                                              </unaryExpressionNotPlusMinus>
                                                            ...
                                                            <unaryExpression>
                                                              <unaryExpressionNotPlusMinus>
                                                                <primary>
                                                                  <literal>
                                                                    <intLiteral>
                                                                      <INTLITERAL startline="17" startpos="15">0</INTLITERAL>
                                                                    </intLiteral>
                                                                  </literal>
                                                                </primary>
                                                              </unaryExpressionNotPlusMinus>
                                                    ...
                                                    <unaryExpression>
                                                      <unaryExpressionNotPlusMinus>
                                                        <primary>
                                                          <literal>
                                                            <intLiteral>
                                                              <INTLITERAL startline="17" startpos="22">2</INTLITERAL>
                                                            </intLiteral>
                                                          </literal>
                                                        </primary>
                                                      </unaryExpressionNotPlusMinus>
