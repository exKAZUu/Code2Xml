<unit language="C">
  <function>
    <type>
      <name>int</name>
    </type> <name>fibonacci2</name><parameter_list>(<param><decl><type><name>int</name></type> <name>n</name></decl></param>)</parameter_list><block>{
	...
	<else>else <if>if<condition>(<expr><name>n</name> == 1 || <name>n</name> == 2</expr>)</condition><then><block>{
