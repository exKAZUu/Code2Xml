                                          ...
                                          <unary_expression>
                                            <postfix_expression>
                                              <primary_expression>
                                                <constant>
                                                  <decimal_literal>
                                                    <DECIMAL_LITERAL startline="2" startpos="8">2</DECIMAL_LITERAL>
                                                  </decimal_literal>
                                                </constant>
                                              </primary_expression>
                                            </postfix_expression>
                                                                                    ...
                                                                                    <unary_expression>
                                                                                      <postfix_expression>
                                                                                        <primary_expression>
                                                                                          <constant>
                                                                                            <decimal_literal>
                                                                                              <DECIMAL_LITERAL startline="6" startpos="23">2</DECIMAL_LITERAL>
                                                                                            </decimal_literal>
                                                                                          </constant>
                                                                                        </primary_expression>
                                                                                      </postfix_expression>
                                                                                    ...
                                                                                    <unary_expression>
                                                                                      <postfix_expression>
                                                                                        <primary_expression>
                                                                                          <constant>
                                                                                            <decimal_literal>
                                                                                              <DECIMAL_LITERAL startline="6" startpos="42">1</DECIMAL_LITERAL>
                                                                                            </decimal_literal>
                                                                                          </constant>
                                                                                        </primary_expression>
                                                                                      </postfix_expression>
