...
# 3 "get_sign/get_sign.c" 2
# 1 "get_sign/get_sign.c"
# 4 "get_sign/get_sign.c"
# 5 "get_sign/get_sign.c"
int get_sign(int x) {
# 6 "get_sign/get_sign.c"
  if (x == 0)
# 7 "get_sign/get_sign.c"
     return 0;
# 8 "get_sign/get_sign.c"
# 9 "get_sign/get_sign.c"
  if (x < 0)
# 10 "get_sign/get_sign.c"
     return -1;
# 11 "get_sign/get_sign.c"
  else
# 12 "get_sign/get_sign.c"
     return 1;
# 13 "get_sign/get_sign.c"
}
# 14 "get_sign/get_sign.c"
# 15 "get_sign/get_sign.c"
int main() {
# 16 "get_sign/get_sign.c"
  int a;
# 17 "get_sign/get_sign.c"
  klee_make_symbolic(&a, sizeof(a), "a");
# 18 "get_sign/get_sign.c"
# 19 "get_sign/get_sign.c"

char *occftmp = getenv("KTEST_FILE");
FILE *occffile = fopen("/home/washizaki-lab/work/klee/examples/Release/get_sign/.successful_tests", "a");
fputs(occftmp, occffile);
fputc('\n', occffile);
fclose(occffile);

  return get_sign(a);
# 20 "get_sign/get_sign.c"
}
